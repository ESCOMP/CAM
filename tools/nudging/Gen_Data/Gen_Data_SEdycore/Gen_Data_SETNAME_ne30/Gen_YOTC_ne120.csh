...
#---------------------------------------------------------
#set fname_grid_info        = '../Grid-Reference/cami_0000-01-01_ne30np4_L30_c120315.nc'
set fname_grid_info        = '../Grid-Reference/cami-mam3_0000-01-ne120np4_L30_c110928.nc'
set fname_phis_output      = '../Grid-Reference/USGS-gtopo30_ne120np4_16xdel2-PFC-consistentSGH.nc'
...
set hourstr = (  000   006   012   018  )

set fname[1] = "YYYY/YYYYMMDD00_HHH_HHH_130128_132128_799.yt.oper.an.ml"
set ftype[1] = "YOTC_sh"
set ftime[1] = "4X"

set fname[2] = "YYYY/YYYYMMDD00_HHH_HHH_129128_152128_799.yt.oper.an.ml"
set ftype[2] = "YOTC_PS_Z"
set ftime[2] = "4X"

set fname[3] = "YYYY/YYYYMMDD00_HHH_HHH_133128_248128_400.yt.oper.an.ml"
set ftype[3] = "ECMWF_gg"
set ftime[3] = "1X"

# Set the OUTPUT fileds and the index of the file containing them
#------------------------------------------------------------------
set fields       = ( U V T PS Q )
set field_findex = ( 1 1 1 2  3 )
...
while ( $NDAYS < $NUM_DAYS )
  ...
  foreach hnum ( 1 2 3 4 )
    ...
    while( $ii <  $fnum )
      ...
      if( $ftime[$ii] == "4X" ) then
        set file = `echo $file | sed 's/HHH/'$hourstr[1]'/'`
        set file = `echo $file | sed 's/HHH/'$hourstr[4]'/'`
      else
        set file = `echo $file | sed 's/HHH/'$hourstr[$hnum]'/g'`
      endif
    ...
    ncl makeIC_se_001.ncl NameNumber=$RUNNUM >& $LOGFILE
