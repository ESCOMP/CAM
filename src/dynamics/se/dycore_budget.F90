...
!         call endrun('dycore_budget module: physics energy budget consistency error 2')
     ...
     write(iulog,*)"------------------------------------------------------------"
     write(iulog,*)" "     
     write(iulog,'(a46,F6.2,a6)')"dE/dt physics tendency in dynamics (dBD-dAF) ",rate_of_change_physics," W/M^2"
     write(iulog,'(a46,F6.2,a6)')"dE/dt physics tendency in physics  (pAM-pBF) ",ph_phys_total," W/M^2"
     write(iulog,*)" "     
     write(iulog,'(a46,F6.2,a6)')"dE/dt physics-dynamics coupling errors       ",ph_phys_total-rate_of_change_physics," W/M^2"
