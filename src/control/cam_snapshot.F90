...
public :: cam_snapshot_init, camdev_snapshot_init, cam_snapshot_deactivate
public :: cam_snapshot_all_outfld, cam_snapshot_all_outfld_tphysbc, cam_snapshot_all_outfld_tphysac
public :: camdev_snapshot_all_outfld_tphysbc, camdev_snapshot_all_outfld_tphysac
...
subroutine camdev_snapshot_init(cam_in_arr, cam_out_arr, pbuf, index)
...
!--------------------------------------------------------
   ...
   call cam_out_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num, cam_out_arr(index))
   call cam_pbuf_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num, pbuf(:,index))
   call camdev_tphysac_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num)
   call camdev_tphysbc_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num)

end subroutine camdev_snapshot_init

subroutine camdev_tphysac_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num)
...
end subroutine camdev_tphysac_snapshot_init

subroutine camdev_tphysbc_snapshot_init(cam_snapshot_before_num, cam_snapshot_after_num)
...
end subroutine camdev_snapshot_all_outfld_tphysac
