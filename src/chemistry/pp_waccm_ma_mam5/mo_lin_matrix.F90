...
!----------------------------------------------
      ...
      do k = 1,avec_len
         ...
         mat(k,555) = -( rxt(k,266) + het_rates(k,89) )
         mat(k,169) = rxt(k,11) + rxt(k,153)
         mat(k,334) = -( rxt(k,128) + het_rates(k,90) )
         ...
         mat(k,361) = -( rxt(k,300) + het_rates(k,97) )
         ...
         mat(k,378) = -( rxt(k,303) + het_rates(k,99) )
         mat(k,672) = rxt(k,73) + rxt(k,74)
         mat(k,505) = rxt(k,79) + rxt(k,81)
         mat(k,185) = rxt(k,287)
         mat(k,191) = rxt(k,288)
         mat(k,188) = -( rxt(k,288) + rxt(k,307) + het_rates(k,100) )
