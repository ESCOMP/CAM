...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,808) = -(rxt(k,194)*y(k,17) + rxt(k,195)*y(k,89) + rxt(k,196)*y(k,71))
         ...
         mat(k,927) = 4.000_r8*rxt(k,197)*y(k,5) + (rxt(k,198)+rxt(k,199))*y(k,28) &
                      + rxt(k,202)*y(k,61) + rxt(k,205)*y(k,69) + rxt(k,256)*y(k,78) &
                      + rxt(k,206)*y(k,98)
         mat(k,59) = rxt(k,184)*y(k,94)
         mat(k,64) = rxt(k,210)*y(k,94)
         mat(k,178) = 2.000_r8*rxt(k,221)*y(k,25) + 2.000_r8*rxt(k,233)*y(k,94) &
                      + 2.000_r8*rxt(k,222)*y(k,98)
         mat(k,216) = rxt(k,223)*y(k,25) + rxt(k,234)*y(k,94) + rxt(k,224)*y(k,98)
         mat(k,165) = 3.000_r8*rxt(k,228)*y(k,25) + 3.000_r8*rxt(k,211)*y(k,94) &
                      + 3.000_r8*rxt(k,229)*y(k,98)
         mat(k,786) = 2.000_r8*rxt(k,221)*y(k,16) + rxt(k,223)*y(k,18) &
                      + 3.000_r8*rxt(k,228)*y(k,24)
         mat(k,616) = (rxt(k,198)+rxt(k,199))*y(k,5)
         mat(k,35) = 2.000_r8*rxt(k,212)*y(k,94)
         mat(k,260) = rxt(k,207)*y(k,69) + rxt(k,213)*y(k,94) + rxt(k,208)*y(k,98)
         ...
         mat(k,931) = -(4._r8*rxt(k,197)*y(k,5) + (rxt(k,198) + rxt(k,199) + rxt(k,200) &
                      ) * y(k,28) + rxt(k,201)*y(k,89) + rxt(k,202)*y(k,61) + rxt(k,203) &
                      *y(k,62) + rxt(k,205)*y(k,69) + rxt(k,206)*y(k,98) + rxt(k,256) &
                      *y(k,78))
         ...
         mat(k,29) = -(rxt(k,183)*y(k,94))
         mat(k,693) = -rxt(k,183)*y(k,8)
         mat(k,55) = -(rxt(k,184)*y(k,94))
         mat(k,698) = -rxt(k,184)*y(k,9)
         mat(k,60) = -(rxt(k,210)*y(k,94))
         mat(k,699) = -rxt(k,210)*y(k,10)
         mat(k,36) = -(rxt(k,185)*y(k,94))
         mat(k,695) = -rxt(k,185)*y(k,11)
         mat(k,65) = -(rxt(k,186)*y(k,94))
         mat(k,700) = -rxt(k,186)*y(k,12)
         mat(k,40) = -(rxt(k,187)*y(k,94))
         mat(k,696) = -rxt(k,187)*y(k,13)
         mat(k,70) = -(rxt(k,188)*y(k,94))
         mat(k,701) = -rxt(k,188)*y(k,14)
         mat(k,44) = -(rxt(k,189)*y(k,94))
         mat(k,697) = -rxt(k,189)*y(k,15)
         mat(k,174) = -(rxt(k,221)*y(k,25) + rxt(k,222)*y(k,98) + rxt(k,233)*y(k,94))
         ...
         mat(k,475) = -(rxt(k,158)*y(k,25) + rxt(k,194)*y(k,3) + rxt(k,238)*y(k,63) &
                      + rxt(k,239)*y(k,69) + rxt(k,240)*y(k,98))
         ...
         mat(k,158) = .300_r8*rxt(k,243)*y(k,98)
         mat(k,397) = (rxt(k,246)+rxt(k,247))*y(k,94)
         ...
         mat(k,210) = -(rxt(k,223)*y(k,25) + rxt(k,224)*y(k,98) + rxt(k,234)*y(k,94))
         mat(k,764) = -rxt(k,223)*y(k,18)
         mat(k,829) = -rxt(k,224)*y(k,18)
         mat(k,711) = -rxt(k,234)*y(k,18)
         mat(k,48) = -(rxt(k,225)*y(k,98))
         mat(k,814) = -rxt(k,225)*y(k,19)
         mat(k,147) = -(rxt(k,226)*y(k,25) + rxt(k,227)*y(k,98))
         mat(k,761) = -rxt(k,226)*y(k,20)
         mat(k,823) = -rxt(k,227)*y(k,20)
         mat(k,411) = -(rxt(k,165)*y(k,28) + rxt(k,241)*y(k,89) + rxt(k,242)*y(k,61))
         mat(k,601) = -rxt(k,165)*y(k,21)
         mat(k,549) = -rxt(k,241)*y(k,21)
         mat(k,741) = -rxt(k,242)*y(k,21)
         mat(k,156) = .700_r8*rxt(k,243)*y(k,98)
         mat(k,394) = rxt(k,159)*y(k,25) + rxt(k,215)*y(k,39) + rxt(k,245)*y(k,94) &
                      + rxt(k,244)*y(k,98)
         ...
         mat(k,155) = -(rxt(k,243)*y(k,98))
         mat(k,824) = -rxt(k,243)*y(k,22)
         mat(k,410) = rxt(k,241)*y(k,89)
         mat(k,543) = rxt(k,241)*y(k,21)
         mat(k,393) = -(rxt(k,159)*y(k,25) + rxt(k,215)*y(k,39) + rxt(k,244)*y(k,98) &
                      + (rxt(k,245) + rxt(k,246) + rxt(k,247)) * y(k,94))
         ...
         mat(k,161) = -(rxt(k,211)*y(k,94) + rxt(k,228)*y(k,25) + rxt(k,229)*y(k,98))
         ...
         mat(k,785) = -(rxt(k,158)*y(k,17) + rxt(k,159)*y(k,23) + rxt(k,160)*y(k,41) &
                      + rxt(k,161)*y(k,43) + (rxt(k,162) + rxt(k,163)) * y(k,89) &
         ...
         mat(k,31) = 4.000_r8*rxt(k,183)*y(k,94)
         mat(k,58) = rxt(k,184)*y(k,94)
         mat(k,39) = 2.000_r8*rxt(k,185)*y(k,94)
         mat(k,69) = 2.000_r8*rxt(k,186)*y(k,94)
         mat(k,43) = 2.000_r8*rxt(k,187)*y(k,94)
         mat(k,74) = rxt(k,188)*y(k,94)
         mat(k,47) = 2.000_r8*rxt(k,189)*y(k,94)
         mat(k,49) = 3.000_r8*rxt(k,225)*y(k,98)
         mat(k,152) = mat(k,152) + rxt(k,227)*y(k,98)
         ...
         mat(k,615) = rxt(k,199)*y(k,5) + rxt(k,165)*y(k,21) + (4.000_r8*rxt(k,166) &
                      ...
                      *y(k,69) + rxt(k,257)*y(k,78) + rxt(k,176)*y(k,98)
         mat(k,93) = rxt(k,220)*y(k,94)
         mat(k,88) = rxt(k,235)*y(k,94) + rxt(k,230)*y(k,98)
         mat(k,98) = rxt(k,236)*y(k,94) + rxt(k,231)*y(k,98)
         mat(k,116) = rxt(k,237)*y(k,94) + rxt(k,232)*y(k,98)
         mat(k,462) = rxt(k,178)*y(k,69) + rxt(k,190)*y(k,94) + rxt(k,179)*y(k,98)
         ...
         mat(k,610) = -(rxt(k,165)*y(k,21) + (4._r8*rxt(k,166) + 4._r8*rxt(k,167) &
                      ...
                      *y(k,89) + rxt(k,170)*y(k,61) + rxt(k,172)*y(k,62) + rxt(k,175) &
                      *y(k,69) + (rxt(k,176) + rxt(k,177)) * y(k,98) + (rxt(k,198) &
                      + rxt(k,199) + rxt(k,200)) * y(k,5) + rxt(k,257)*y(k,78))
         ...
         mat(k,780) = rxt(k,180)*y(k,54) + rxt(k,164)*y(k,71) + rxt(k,163)*y(k,89)
         mat(k,311) = rxt(k,173)*y(k,69)
         mat(k,458) = rxt(k,191)*y(k,94)
         mat(k,267) = rxt(k,180)*y(k,25) + rxt(k,181)*y(k,69) + rxt(k,182)*y(k,98)
         mat(k,681) = mat(k,681) + rxt(k,173)*y(k,29) + rxt(k,181)*y(k,54)
         mat(k,532) = rxt(k,164)*y(k,25)
         mat(k,137) = rxt(k,262)*y(k,78)
         mat(k,430) = mat(k,430) + rxt(k,262)*y(k,72)
         mat(k,557) = mat(k,557) + rxt(k,163)*y(k,25)
         mat(k,723) = rxt(k,191)*y(k,49)
         mat(k,851) = mat(k,851) + rxt(k,182)*y(k,54)
         mat(k,308) = -(rxt(k,171)*y(k,25) + rxt(k,173)*y(k,69) + rxt(k,174)*y(k,98) &
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,197) = rxt(k,302)*y(k,99)
         mat(k,571) = rxt(k,238)*y(k,17)
         mat(k,665) = rxt(k,239)*y(k,17) + rxt(k,251)*y(k,73)
         mat(k,141) = rxt(k,251)*y(k,69) + rxt(k,252)*y(k,98)
         mat(k,834) = mat(k,834) + rxt(k,240)*y(k,17) + rxt(k,252)*y(k,73)
         mat(k,373) = rxt(k,302)*y(k,32)
         mat(k,196) = -(rxt(k,302)*y(k,99))
         mat(k,370) = -rxt(k,302)*y(k,32)
         mat(k,281) = rxt(k,248)*y(k,98)
         mat(k,828) = rxt(k,248)*y(k,31)
         mat(k,82) = -(rxt(k,219)*y(k,94))
         mat(k,703) = -rxt(k,219)*y(k,33)
         mat(k,56) = rxt(k,184)*y(k,94)
         mat(k,61) = rxt(k,210)*y(k,94)
         mat(k,66) = rxt(k,186)*y(k,94)
         mat(k,41) = 2.000_r8*rxt(k,187)*y(k,94)
         mat(k,71) = 2.000_r8*rxt(k,188)*y(k,94)
         mat(k,45) = rxt(k,189)*y(k,94)
         mat(k,33) = 2.000_r8*rxt(k,212)*y(k,94)
         mat(k,94) = rxt(k,236)*y(k,94) + rxt(k,231)*y(k,98)
         mat(k,112) = rxt(k,237)*y(k,94) + rxt(k,232)*y(k,98)
         ...
         mat(k,90) = -(rxt(k,220)*y(k,94))
         mat(k,705) = -rxt(k,220)*y(k,34)
         mat(k,37) = rxt(k,185)*y(k,94)
         mat(k,67) = rxt(k,186)*y(k,94)
         mat(k,86) = rxt(k,235)*y(k,94) + rxt(k,230)*y(k,98)
         mat(k,705) = mat(k,705) + rxt(k,185)*y(k,11) + rxt(k,186)*y(k,12) &
                      + rxt(k,235)*y(k,46)
         mat(k,817) = rxt(k,230)*y(k,46)
         mat(k,128) = -(rxt(k,249)*y(k,63) + (rxt(k,250) + rxt(k,264)) * y(k,98))
         mat(k,570) = -rxt(k,249)*y(k,35)
         mat(k,821) = -(rxt(k,250) + rxt(k,264)) * y(k,35)
         mat(k,290) = -(rxt(k,215)*y(k,23) + rxt(k,216)*y(k,41) + rxt(k,217)*y(k,102) &
                      + rxt(k,218)*y(k,51))
         mat(k,390) = -rxt(k,215)*y(k,39)
         mat(k,864) = -rxt(k,216)*y(k,39)
         mat(k,936) = -rxt(k,217)*y(k,39)
         mat(k,887) = -rxt(k,218)*y(k,39)
         mat(k,62) = rxt(k,210)*y(k,94)
         mat(k,72) = rxt(k,188)*y(k,94)
         mat(k,83) = 2.000_r8*rxt(k,219)*y(k,94)
         mat(k,91) = rxt(k,220)*y(k,94)
         ...
         mat(k,473) = rxt(k,240)*y(k,98)
         mat(k,395) = rxt(k,246)*y(k,94)
         ...
         mat(k,107) = rxt(k,265)*y(k,102)
         mat(k,933) = rxt(k,265)*y(k,80)
         mat(k,256) = -(rxt(k,207)*y(k,69) + rxt(k,208)*y(k,98) + (rxt(k,213) &
                      + rxt(k,214)) * y(k,94))
         mat(k,662) = -rxt(k,207)*y(k,45)
         mat(k,832) = -rxt(k,208)*y(k,45)
         mat(k,712) = -(rxt(k,213) + rxt(k,214)) * y(k,45)
         mat(k,792) = rxt(k,194)*y(k,17) + rxt(k,195)*y(k,89)
         mat(k,469) = rxt(k,194)*y(k,3)
         mat(k,547) = rxt(k,195)*y(k,3)
         mat(k,85) = -(rxt(k,230)*y(k,98) + rxt(k,235)*y(k,94))
         mat(k,816) = -rxt(k,230)*y(k,46)
         mat(k,704) = -rxt(k,235)*y(k,46)
         mat(k,95) = -(rxt(k,231)*y(k,98) + rxt(k,236)*y(k,94))
         mat(k,818) = -rxt(k,231)*y(k,47)
         mat(k,706) = -rxt(k,236)*y(k,47)
         mat(k,113) = -(rxt(k,232)*y(k,98) + rxt(k,237)*y(k,94))
         mat(k,820) = -rxt(k,232)*y(k,48)
         mat(k,708) = -rxt(k,237)*y(k,48)
         mat(k,453) = -(rxt(k,178)*y(k,69) + rxt(k,179)*y(k,98) + (rxt(k,190) &
                      + rxt(k,191)) * y(k,94) + (rxt(k,271) + rxt(k,277) + rxt(k,282) &
         ...
         mat(k,774) = rxt(k,221)*y(k,16) + rxt(k,158)*y(k,17) + rxt(k,223)*y(k,18) &
                      ...
                      *y(k,54) + rxt(k,162)*y(k,89)
         mat(k,604) = rxt(k,177)*y(k,98)
         ...
         mat(k,906) = -(rxt(k,152)*y(k,98) + rxt(k,218)*y(k,39))
         ...
         mat(k,912) = rxt(k,201)*y(k,89)
         mat(k,546) = rxt(k,201)*y(k,5)
         mat(k,265) = -(rxt(k,180)*y(k,25) + rxt(k,181)*y(k,69) + rxt(k,182)*y(k,98) &
         ...
         mat(k,670) = rxt(k,131)*y(k,90) + rxt(k,296)*y(k,93)
         mat(k,503) = mat(k,503) + rxt(k,297)*y(k,93)
         mat(k,325) = rxt(k,154)*y(k,90) + 1.100_r8*rxt(k,292)*y(k,91) &
                      + .200_r8*rxt(k,290)*y(k,92)
         mat(k,335) = rxt(k,131)*y(k,69) + rxt(k,154)*y(k,88)
         mat(k,223) = 1.100_r8*rxt(k,292)*y(k,88)
         mat(k,245) = .200_r8*rxt(k,290)*y(k,88)
         ...
         mat(k,752) = -(rxt(k,130)*y(k,90) + rxt(k,132)*y(k,55) + rxt(k,140)*y(k,63) &
                      + rxt(k,144)*y(k,89) + rxt(k,145)*y(k,71) + rxt(k,146)*y(k,69) &
         ...
         mat(k,515) = rxt(k,157)*y(k,55) + rxt(k,155)*y(k,90)
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,640) = -((rxt(k,133) + rxt(k,134) + rxt(k,135)) * y(k,55) + (rxt(k,136) &
                      ...
                      *y(k,89) + rxt(k,150)*y(k,63) + rxt(k,151)*y(k,98) + rxt(k,172) &
                      *y(k,28) + rxt(k,203)*y(k,5) + rxt(k,259)*y(k,78))
         ...
         mat(k,581) = -(rxt(k,139)*y(k,89) + rxt(k,140)*y(k,61) + rxt(k,141)*y(k,69) &
                      + rxt(k,142)*y(k,98) + rxt(k,150)*y(k,62) + rxt(k,238)*y(k,17) &
                      + rxt(k,249)*y(k,35))
         ...
         mat(k,310) = rxt(k,171)*y(k,25) + rxt(k,173)*y(k,69) + rxt(k,174)*y(k,98)
         mat(k,294) = rxt(k,218)*y(k,51)
         mat(k,896) = rxt(k,218)*y(k,39) + rxt(k,152)*y(k,98)
         ...
         mat(k,683) = -(rxt(k,108)*y(k,71) + 4._r8*rxt(k,109)*y(k,69) + rxt(k,110) &
                      ...
                      *y(k,73) + (rxt(k,294) + rxt(k,295)) * y(k,91) + rxt(k,296) &
                      *y(k,93))
         ...
         mat(k,353) = rxt(k,132)*y(k,61) + rxt(k,133)*y(k,62) + rxt(k,157)*y(k,70) &
                      + rxt(k,299)*y(k,97)
         mat(k,750) = mat(k,750) + rxt(k,132)*y(k,55) + rxt(k,130)*y(k,90)
         mat(k,641) = mat(k,641) + rxt(k,133)*y(k,55)
         mat(k,513) = mat(k,513) + rxt(k,157)*y(k,55) + rxt(k,253)*y(k,76) &
                      + rxt(k,260)*y(k,78) + rxt(k,298)*y(k,93) + (rxt(k,97)+rxt(k,98)) &
                      *y(k,94) + rxt(k,305)*y(k,99) + rxt(k,309)*y(k,100)
         mat(k,240) = rxt(k,253)*y(k,70)
         mat(k,432) = rxt(k,260)*y(k,70)
         mat(k,329) = rxt(k,290)*y(k,92) + 1.150_r8*rxt(k,291)*y(k,97)
         mat(k,559) = mat(k,559) + rxt(k,115)*y(k,40)
         mat(k,339) = rxt(k,130)*y(k,61) + rxt(k,304)*y(k,99)
         mat(k,246) = rxt(k,290)*y(k,88)
         mat(k,280) = mat(k,280) + rxt(k,298)*y(k,70)
         mat(k,725) = (rxt(k,97)+rxt(k,98))*y(k,70)
         mat(k,366) = rxt(k,299)*y(k,55) + 1.150_r8*rxt(k,291)*y(k,88)
         mat(k,853) = mat(k,853) + 2.000_r8*rxt(k,125)*y(k,98)
         mat(k,383) = rxt(k,305)*y(k,70) + rxt(k,304)*y(k,90)
         mat(k,193) = rxt(k,309)*y(k,70)
         mat(k,508) = -(rxt(k,97)*y(k,94) + rxt(k,102)*y(k,95) + rxt(k,110)*y(k,69) &
                      + rxt(k,116)*y(k,40) + rxt(k,155)*y(k,90) + rxt(k,157)*y(k,55) &
                      + rxt(k,253)*y(k,76) + rxt(k,260)*y(k,78) + rxt(k,293)*y(k,91) &
                      + (rxt(k,297) + rxt(k,298)) * y(k,93) + rxt(k,305)*y(k,99) &
                      + rxt(k,309)*y(k,100))
         ...
         mat(k,528) = rxt(k,196)*y(k,3) + rxt(k,164)*y(k,25) + rxt(k,119)*y(k,40) &
                      ...
                      *y(k,69) + rxt(k,255)*y(k,76) + rxt(k,261)*y(k,78) &
         ...
         mat(k,529) = -(rxt(k,99)*y(k,94) + rxt(k,108)*y(k,69) + rxt(k,118)*y(k,89) &
                      ...
                      + rxt(k,255)*y(k,76) + rxt(k,261)*y(k,78))
         ...
         mat(k,134) = -(rxt(k,262)*y(k,78))
         mat(k,422) = -rxt(k,262)*y(k,72)
         mat(k,910) = rxt(k,198)*y(k,28)
         mat(k,597) = rxt(k,198)*y(k,5) + 2.000_r8*rxt(k,168)*y(k,28)
         mat(k,139) = -(rxt(k,251)*y(k,69) + rxt(k,252)*y(k,98))
         mat(k,653) = -rxt(k,251)*y(k,73)
         mat(k,822) = -rxt(k,252)*y(k,73)
         mat(k,235) = -(rxt(k,253)*y(k,70) + rxt(k,255)*y(k,71) + rxt(k,258)*y(k,98))
         mat(k,497) = -rxt(k,253)*y(k,76)
         mat(k,524) = -rxt(k,255)*y(k,76)
         mat(k,831) = -rxt(k,258)*y(k,76)
         mat(k,425) = -(rxt(k,256)*y(k,5) + rxt(k,257)*y(k,28) + rxt(k,259)*y(k,62) &
                      + rxt(k,260)*y(k,70) + rxt(k,261)*y(k,71) + rxt(k,262)*y(k,72) &
                      + rxt(k,263)*y(k,98))
         mat(k,914) = -rxt(k,256)*y(k,78)
         mat(k,602) = -rxt(k,257)*y(k,78)
         mat(k,632) = -rxt(k,259)*y(k,78)
         mat(k,506) = -rxt(k,260)*y(k,78)
         mat(k,526) = -rxt(k,261)*y(k,78)
         mat(k,136) = -rxt(k,262)*y(k,78)
         mat(k,843) = -rxt(k,263)*y(k,78)
         mat(k,673) = rxt(k,251)*y(k,73)
         mat(k,506) = mat(k,506) + rxt(k,253)*y(k,76)
         mat(k,526) = mat(k,526) + rxt(k,255)*y(k,76)
         mat(k,143) = rxt(k,251)*y(k,69)
         mat(k,236) = rxt(k,253)*y(k,70) + rxt(k,255)*y(k,71) + rxt(k,258)*y(k,98)
         mat(k,843) = mat(k,843) + rxt(k,258)*y(k,76)
         mat(k,300) = -(rxt(k,254)*y(k,98))
         mat(k,836) = -rxt(k,254)*y(k,79)
         mat(k,913) = rxt(k,256)*y(k,78)
         mat(k,599) = rxt(k,257)*y(k,78)
         mat(k,129) = rxt(k,249)*y(k,63) + (rxt(k,250)+.500_r8*rxt(k,264))*y(k,98)
         mat(k,627) = rxt(k,259)*y(k,78)
         mat(k,572) = rxt(k,249)*y(k,35)
         mat(k,500) = rxt(k,260)*y(k,78)
         mat(k,525) = rxt(k,261)*y(k,78)
         mat(k,135) = rxt(k,262)*y(k,78)
         mat(k,142) = rxt(k,252)*y(k,98)
         mat(k,424) = rxt(k,256)*y(k,5) + rxt(k,257)*y(k,28) + rxt(k,259)*y(k,62) &
                      + rxt(k,260)*y(k,70) + rxt(k,261)*y(k,71) + rxt(k,262)*y(k,72) &
                      + rxt(k,263)*y(k,98)
         mat(k,836) = mat(k,836) + (rxt(k,250)+.500_r8*rxt(k,264))*y(k,35) &
                      + rxt(k,252)*y(k,73) + rxt(k,263)*y(k,78)
      end do
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,108) = -(rxt(k,265)*y(k,102))
         mat(k,934) = -rxt(k,265)*y(k,80)
         mat(k,299) = rxt(k,254)*y(k,98)
         mat(k,819) = rxt(k,254)*y(k,79)
         mat(k,323) = -(rxt(k,290)*y(k,92) + rxt(k,291)*y(k,97) + rxt(k,292)*y(k,91))
         mat(k,243) = -rxt(k,290)*y(k,88)
         mat(k,358) = -rxt(k,291)*y(k,88)
         mat(k,221) = -rxt(k,292)*y(k,88)
         ...
         mat(k,778) = -(rxt(k,162) + rxt(k,163)) * y(k,89)
         mat(k,608) = -rxt(k,169)*y(k,89)
         mat(k,800) = -rxt(k,195)*y(k,89)
         mat(k,919) = -rxt(k,201)*y(k,89)
         mat(k,415) = -rxt(k,241)*y(k,89)
         mat(k,800) = mat(k,800) + rxt(k,194)*y(k,17)
         mat(k,919) = mat(k,919) + rxt(k,206)*y(k,98)
         mat(k,478) = rxt(k,194)*y(k,3) + rxt(k,158)*y(k,25) + rxt(k,238)*y(k,63) &
                      + rxt(k,239)*y(k,69)
         mat(k,213) = rxt(k,223)*y(k,25) + rxt(k,224)*y(k,98)
         mat(k,151) = rxt(k,226)*y(k,25) + rxt(k,227)*y(k,98)
         mat(k,415) = mat(k,415) + rxt(k,165)*y(k,28) + rxt(k,242)*y(k,61)
         mat(k,399) = rxt(k,246)*y(k,94)
         mat(k,778) = mat(k,778) + rxt(k,158)*y(k,17) + rxt(k,223)*y(k,18) &
                      + rxt(k,226)*y(k,20) + rxt(k,161)*y(k,43)
         mat(k,608) = mat(k,608) + rxt(k,165)*y(k,21) + rxt(k,176)*y(k,98)
         mat(k,286) = rxt(k,248)*y(k,98)
         mat(k,130) = .500_r8*rxt(k,264)*y(k,98)
         mat(k,442) = mat(k,442) + rxt(k,116)*y(k,70)
         mat(k,230) = rxt(k,161)*y(k,25) + rxt(k,112)*y(k,69) + rxt(k,121)*y(k,98)
         mat(k,746) = mat(k,746) + rxt(k,242)*y(k,21)
         mat(k,580) = mat(k,580) + rxt(k,238)*y(k,17) + rxt(k,142)*y(k,98)
         mat(k,679) = mat(k,679) + rxt(k,239)*y(k,17) + rxt(k,112)*y(k,43)
         mat(k,510) = rxt(k,116)*y(k,40)
         mat(k,530) = mat(k,530) + rxt(k,124)*y(k,98)
         mat(k,302) = rxt(k,254)*y(k,98)
         ...
         mat(k,849) = mat(k,849) + rxt(k,206)*y(k,5) + rxt(k,224)*y(k,18) + rxt(k,227) &
                      ...
                      *y(k,63) + rxt(k,124)*y(k,71) + rxt(k,254)*y(k,79)
         mat(k,334) = -(rxt(k,130)*y(k,61) + rxt(k,131)*y(k,69) + rxt(k,154)*y(k,88) &
                      + rxt(k,155)*y(k,70) + rxt(k,304)*y(k,99))
         mat(k,737) = -rxt(k,130)*y(k,90)
         mat(k,669) = -rxt(k,131)*y(k,90)
         mat(k,324) = -rxt(k,154)*y(k,90)
         mat(k,502) = -rxt(k,155)*y(k,90)
         mat(k,375) = -rxt(k,304)*y(k,90)
         mat(k,669) = mat(k,669) + rxt(k,294)*y(k,91)
         mat(k,324) = mat(k,324) + .900_r8*rxt(k,292)*y(k,91) + .800_r8*rxt(k,290) &
                      *y(k,92)
         mat(k,222) = rxt(k,294)*y(k,69) + .900_r8*rxt(k,292)*y(k,88)
         mat(k,244) = .800_r8*rxt(k,290)*y(k,88)
         mat(k,219) = -(rxt(k,292)*y(k,88) + rxt(k,293)*y(k,70) + (rxt(k,294) &
                      + rxt(k,295)) * y(k,69))
         mat(k,320) = -rxt(k,292)*y(k,91)
         mat(k,496) = -rxt(k,293)*y(k,91)
         mat(k,657) = -(rxt(k,294) + rxt(k,295)) * y(k,91)
         mat(k,242) = -(rxt(k,290)*y(k,88))
         mat(k,321) = -rxt(k,290)*y(k,92)
         mat(k,343) = rxt(k,299)*y(k,97)
         mat(k,735) = rxt(k,301)*y(k,97)
         mat(k,660) = rxt(k,294)*y(k,91)
         mat(k,498) = rxt(k,298)*y(k,93)
         ...
         mat(k,664) = -rxt(k,296)*y(k,93)
         mat(k,499) = -(rxt(k,297) + rxt(k,298)) * y(k,93)
         mat(k,332) = rxt(k,304)*y(k,99)
         mat(k,372) = rxt(k,304)*y(k,90)
         ...
         mat(k,30) = -rxt(k,183)*y(k,94)
         mat(k,57) = -rxt(k,184)*y(k,94)
         mat(k,38) = -rxt(k,185)*y(k,94)
         mat(k,68) = -rxt(k,186)*y(k,94)
         mat(k,42) = -rxt(k,187)*y(k,94)
         mat(k,73) = -rxt(k,188)*y(k,94)
         mat(k,46) = -rxt(k,189)*y(k,94)
         mat(k,461) = -(rxt(k,190) + rxt(k,191)) * y(k,94)
         mat(k,63) = -rxt(k,210)*y(k,94)
         mat(k,163) = -rxt(k,211)*y(k,94)
         mat(k,34) = -rxt(k,212)*y(k,94)
         mat(k,259) = -(rxt(k,213) + rxt(k,214)) * y(k,94)
         mat(k,84) = -rxt(k,219)*y(k,94)
         mat(k,92) = -rxt(k,220)*y(k,94)
         mat(k,176) = -rxt(k,233)*y(k,94)
         mat(k,214) = -rxt(k,234)*y(k,94)
         mat(k,87) = -rxt(k,235)*y(k,94)
         mat(k,97) = -rxt(k,236)*y(k,94)
         mat(k,115) = -rxt(k,237)*y(k,94)
         mat(k,403) = -(rxt(k,245) + rxt(k,246) + rxt(k,247)) * y(k,94)
         mat(k,514) = mat(k,514) + rxt(k,155)*y(k,90)
         mat(k,330) = .850_r8*rxt(k,291)*y(k,97)
         mat(k,340) = rxt(k,155)*y(k,70)
         mat(k,367) = .850_r8*rxt(k,291)*y(k,88)
         ...
         mat(k,361) = -(rxt(k,291)*y(k,88) + rxt(k,299)*y(k,55) + rxt(k,301)*y(k,61))
         mat(k,326) = -rxt(k,291)*y(k,97)
         mat(k,348) = -rxt(k,299)*y(k,97)
         mat(k,739) = -rxt(k,301)*y(k,97)
         mat(k,198) = rxt(k,302)*y(k,99)
         mat(k,504) = rxt(k,293)*y(k,91) + rxt(k,297)*y(k,93) + rxt(k,305)*y(k,99) &
                      + rxt(k,309)*y(k,100)
         ...
         mat(k,858) = -(rxt(k,120)*y(k,41) + rxt(k,121)*y(k,43) + rxt(k,122)*y(k,89) &
                      ...
                      + 4._r8*rxt(k,126)) * y(k,98) + rxt(k,129)*y(k,52) + rxt(k,142) &
                      ...
                      *y(k,23) + rxt(k,248)*y(k,31) + (rxt(k,250) + rxt(k,264) &
                      ) * y(k,35) + rxt(k,252)*y(k,73) + rxt(k,254)*y(k,79) + rxt(k,258) &
                      *y(k,76) + rxt(k,263)*y(k,78))
         ...
         mat(k,172) = -rxt(k,129)*y(k,98)
         mat(k,589) = -rxt(k,142)*y(k,98)
         mat(k,356) = -rxt(k,143)*y(k,98)
         mat(k,646) = -rxt(k,151)*y(k,98)
         mat(k,904) = -rxt(k,152)*y(k,98)
         mat(k,315) = -rxt(k,174)*y(k,98)
         mat(k,617) = -(rxt(k,176) + rxt(k,177)) * y(k,98)
         mat(k,464) = -rxt(k,179)*y(k,98)
         mat(k,270) = -rxt(k,182)*y(k,98)
         mat(k,928) = -rxt(k,206)*y(k,98)
         mat(k,261) = -rxt(k,208)*y(k,98)
         mat(k,179) = -rxt(k,222)*y(k,98)
         mat(k,217) = -rxt(k,224)*y(k,98)
         mat(k,50) = -rxt(k,225)*y(k,98)
         mat(k,153) = -rxt(k,227)*y(k,98)
         mat(k,166) = -rxt(k,229)*y(k,98)
         mat(k,89) = -rxt(k,230)*y(k,98)
         mat(k,99) = -rxt(k,231)*y(k,98)
         mat(k,117) = -rxt(k,232)*y(k,98)
         mat(k,487) = -rxt(k,240)*y(k,98)
         mat(k,159) = -rxt(k,243)*y(k,98)
         mat(k,406) = -rxt(k,244)*y(k,98)
         mat(k,288) = -rxt(k,248)*y(k,98)
         mat(k,132) = -(rxt(k,250) + rxt(k,264)) * y(k,98)
         mat(k,146) = -rxt(k,252)*y(k,98)
         mat(k,304) = -rxt(k,254)*y(k,98)
         mat(k,241) = -rxt(k,258)*y(k,98)
         mat(k,436) = -rxt(k,263)*y(k,98)
         mat(k,487) = mat(k,487) + rxt(k,239)*y(k,69)
         mat(k,159) = mat(k,159) + .300_r8*rxt(k,243)*y(k,98)
         mat(k,406) = mat(k,406) + rxt(k,245)*y(k,94)
         mat(k,787) = rxt(k,163)*y(k,89)
         mat(k,295) = rxt(k,217)*y(k,102)
         ...
         mat(k,261) = mat(k,261) + rxt(k,207)*y(k,69) + rxt(k,213)*y(k,94)
         mat(k,464) = mat(k,464) + rxt(k,178)*y(k,69) + rxt(k,190)*y(k,94)
         ...
         mat(k,688) = mat(k,688) + rxt(k,239)*y(k,17) + rxt(k,111)*y(k,41) &
                      ...
                      + rxt(k,209)*y(k,53) + rxt(k,181)*y(k,54) + rxt(k,117)*y(k,89)
         ...
         mat(k,730) = rxt(k,245)*y(k,23) + rxt(k,94)*y(k,41) + rxt(k,213)*y(k,45) &
                      + rxt(k,190)*y(k,49) + 2.000_r8*rxt(k,95)*y(k,102)
         mat(k,858) = mat(k,858) + .300_r8*rxt(k,243)*y(k,22)
         mat(k,955) = rxt(k,217)*y(k,39) + 2.000_r8*rxt(k,95)*y(k,94)
      end do
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,378) = -(rxt(k,302)*y(k,32) + rxt(k,304)*y(k,90) + rxt(k,305)*y(k,70))
         mat(k,199) = -rxt(k,302)*y(k,99)
         mat(k,337) = -rxt(k,304)*y(k,99)
         mat(k,505) = -rxt(k,305)*y(k,99)
         mat(k,672) = rxt(k,295)*y(k,91) + rxt(k,296)*y(k,93) + rxt(k,308)*y(k,100) &
                      + rxt(k,314)*y(k,101)
         mat(k,327) = rxt(k,306)*y(k,100) + rxt(k,311)*y(k,101)
         mat(k,225) = rxt(k,295)*y(k,69)
         mat(k,278) = rxt(k,296)*y(k,69)
         mat(k,191) = rxt(k,308)*y(k,69) + rxt(k,306)*y(k,88)
         mat(k,185) = rxt(k,314)*y(k,69) + rxt(k,311)*y(k,88)
         mat(k,188) = -(rxt(k,306)*y(k,88) + rxt(k,308)*y(k,69) + rxt(k,309)*y(k,70))
         mat(k,319) = -rxt(k,306)*y(k,100)
         mat(k,655) = -rxt(k,308)*y(k,100)
         mat(k,495) = -rxt(k,309)*y(k,100)
         mat(k,319) = mat(k,319) + rxt(k,310)*y(k,101)
         mat(k,182) = rxt(k,310)*y(k,88)
         mat(k,181) = -((rxt(k,310) + rxt(k,311)) * y(k,88) + rxt(k,314)*y(k,69))
         mat(k,318) = -(rxt(k,310) + rxt(k,311)) * y(k,101)
         mat(k,654) = -rxt(k,314)*y(k,101)
         mat(k,959) = -(rxt(k,95)*y(k,94) + rxt(k,217)*y(k,39) + rxt(k,265)*y(k,80))
         mat(k,734) = -rxt(k,95)*y(k,102)
         mat(k,298) = -rxt(k,217)*y(k,102)
         mat(k,111) = -rxt(k,265)*y(k,102)
         mat(k,180) = rxt(k,222)*y(k,98)
         mat(k,491) = rxt(k,240)*y(k,98)
         mat(k,218) = rxt(k,224)*y(k,98)
         mat(k,51) = rxt(k,225)*y(k,98)
         mat(k,154) = rxt(k,227)*y(k,98)
         mat(k,160) = rxt(k,243)*y(k,98)
         mat(k,409) = rxt(k,244)*y(k,98)
         mat(k,446) = rxt(k,115)*y(k,89)
         mat(k,885) = rxt(k,120)*y(k,98)
         mat(k,234) = rxt(k,121)*y(k,98)
         mat(k,263) = rxt(k,208)*y(k,98)
         mat(k,118) = rxt(k,232)*y(k,98)
         mat(k,468) = (rxt(k,278)+rxt(k,283))*y(k,53) + (rxt(k,271)+rxt(k,277) &
                       +rxt(k,282))*y(k,54) + rxt(k,179)*y(k,98)
         mat(k,908) = rxt(k,152)*y(k,98)
         mat(k,173) = rxt(k,129)*y(k,98)
         mat(k,255) = (rxt(k,278)+rxt(k,283))*y(k,49)
         mat(k,271) = (rxt(k,271)+rxt(k,277)+rxt(k,282))*y(k,49) + rxt(k,182)*y(k,98)
