...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,594)*y(:,248)*y(:,149) +rxt(:,604)*y(:,150)
         prod(:,2) = (rxt(:,506)*y(:,229) +rxt(:,509)*y(:,241) +rxt(:,512)*y(:,243) + &
                 rxt(:,516)*y(:,171))*y(:,154) +.500_r8*rxt(:,445)*y(:,248)*y(:,138) &
                  +.200_r8*rxt(:,541)*y(:,246)*y(:,153) +.500_r8*rxt(:,553)*y(:,207) &
                 *y(:,155)
!--------------------------------------------------------------------
