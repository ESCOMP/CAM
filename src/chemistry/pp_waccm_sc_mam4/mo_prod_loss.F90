...
!--------------------------------------------------------------------
         ...
         prod(5) = 0._r8
         loss(6) = ( + rxt(11) + rxt(12) + rxt(14) + het_rates(6))* y(6)
         prod(6) = 0._r8
         ...
         prod(9) = 0._r8
         loss(10) = ( + rxt(1) + rxt(5) + het_rates(10))* y(10)
         prod(10) = 0._r8
         loss(11) = ( + het_rates(11))* y(11)
         prod(11) =rxt(13)*y(22)
         loss(12) = ( + rxt(7) + het_rates(12))* y(12)
         prod(12) = 0._r8
         ...
         prod(22) = (rxt(11) +rxt(12) +.500_r8*rxt(14))*y(6)
         ...
         prod(25) = 0._r8
         loss(26) = ( + rxt(2) + het_rates(26))* y(26)
         prod(26) = 0._r8
         loss(27) = ( + rxt(3) + het_rates(27))* y(27)
         prod(27) = 0._r8
         loss(28) = ( + rxt(15) + het_rates(28))* y(28)
         prod(28) = 0._r8
         loss(29) = ( + het_rates(29))* y(29)
         prod(29) =rxt(15)*y(28)
         loss(30) = ( + rxt(4) + het_rates(30))* y(30)
         prod(30) =2.000_r8*rxt(10)*y(5) +rxt(5)*y(10)
