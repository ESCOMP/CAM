...
!--------------------------------------------------------------
      ...
      solsym(: 30) = (/ 'bc_a1           ','bc_a4           ','CFC11           ','CFC12           ','CH4             ', &
                        'DMS             ','dst_a1          ','dst_a2          ','dst_a3          ','H2O2            ', &
                        'H2SO4           ','N2O             ','ncl_a1          ','ncl_a2          ','ncl_a3          ', &
                        'num_a1          ','num_a2          ','num_a3          ','num_a4          ','pom_a1          ', &
                        'pom_a4          ','SO2             ','so4_a1          ','so4_a2          ','so4_a3          ', &
                        'soa_a1          ','soa_a2          ','SOAE            ','SOAG            ','H2O             ' /)

      adv_mass(: 30) = (/    12.011000_r8,    12.011000_r8,   137.367503_r8,   120.913206_r8,    16.040600_r8, &
                             62.132400_r8,   135.064039_r8,   135.064039_r8,   135.064039_r8,    34.013600_r8, &
                             98.078400_r8,    44.012880_r8,    58.442468_r8,    58.442468_r8,    58.442468_r8, &
                              1.007400_r8,     1.007400_r8,     1.007400_r8,     1.007400_r8,    12.011000_r8, &
                             12.011000_r8,    64.064800_r8,   115.107340_r8,   115.107340_r8,   115.107340_r8, &
                             12.011000_r8,    12.011000_r8,    12.011000_r8,    12.011000_r8,    18.014200_r8 /)

      crb_mass(: 30) = (/    12.011000_r8,    12.011000_r8,    12.011000_r8,    12.011000_r8,    12.011000_r8, &
