...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 123, & ! number of photolysis reactions
                            rxntot = 553, & ! number of total reactions
                            gascnt = 430, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 233, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 2374, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 231, & ! number of species in implicit class
