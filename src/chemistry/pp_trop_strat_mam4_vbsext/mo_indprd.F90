...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,498)*y(:,251)*y(:,127) +rxt(:,506)*y(:,128)
         prod(:,2) = (rxt(:,431)*y(:,236) +rxt(:,434)*y(:,245) +rxt(:,437)*y(:,247) + &
                 rxt(:,441)*y(:,146))*y(:,130) +.500_r8*rxt(:,370)*y(:,251)*y(:,115) &
                  +.200_r8*rxt(:,466)*y(:,249)*y(:,129) +.500_r8*rxt(:,478)*y(:,214) &
                 *y(:,131)
!--------------------------------------------------------------------
