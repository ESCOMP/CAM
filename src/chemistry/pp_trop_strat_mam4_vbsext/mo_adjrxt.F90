...
!--------------------------------------------------------------------
      ...
      rate(:,:,146) = rate(:,:,146) * inv(:,:, 3)
      rate(:,:,147) = rate(:,:,147) * inv(:,:, 2)
      rate(:,:,150) = rate(:,:,150) * inv(:,:, 1)
      rate(:,:,167) = rate(:,:,167) * inv(:,:, 1)
      rate(:,:,174) = rate(:,:,174) * inv(:,:, 2)
      ...
      rate(:,:,484) = rate(:,:,484) * inv(:,:, 2)
      rate(:,:,490) = rate(:,:,490) * inv(:,:, 2)
      rate(:,:,151) = rate(:,:,151) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,157) = rate(:,:,157) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,144) = rate(:,:,144) * m(:,:)
      rate(:,:,145) = rate(:,:,145) * m(:,:)
      rate(:,:,148) = rate(:,:,148) * m(:,:)
      rate(:,:,149) = rate(:,:,149) * m(:,:)
