...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 143, & ! number of photolysis reactions
                            ...
                            clscnt4 = 259, & ! number of species in implicit class
