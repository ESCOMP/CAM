...
!--------------------------------------------------------------
      ...
      solsym(:284) = (/ 'CH2I2          ','CH2IBr         ','CH2ICl         ', & 
                        'AERI           ','CO2            ','INDIOL         ', & 
                        'ISALA          ','ISALC          ','LBRO2H         ', & 
                        ...
                        'MAP            ','CHBr3          ','CHCl3          ', & 
                        'IBr            ','MPN            ','Cl2O2          ', & 
                        'CH2Br2         ','CH2Cl2         ','HCFC22         ', & 
                        'HMHP           ','HMML           ','IPRNO3         ', & 
                        'ETNO3          ','MENO3          ','NPRNO3         ', & 
                        'OIO            ','R4P            ','RA3P           ', & 
                        'RB3P           ','RP             ','XYLE           ', & 
                        'HCFC123        ','DMS            ','HCFC141b       ', & 
                        ...
                        'RIPB           ','MCRENOL        ','IDHPE          ', & 
                        'RIPD           ','HNO2           ','ISOPNOO1       ', & 
                        'IDHNDOO1       ','IDHNDOO2       ','LIMO           ', & 
                        'MVKHC          ','RIPC           ','HPETHNL        ', & 
                        'N2O5           ','ICHE           ','MCRHNB         ', & 
                        'H              ','BrNO3          ','MONITS         ', & 
                        'INPB           ','IHPOO2         ','IHPOO1         ', & 
                        'MVKHCB         ','IHPOO3         ','CH4            ', & 
                        'IHPNDOO        ','HPALD1         ','HPALD2         ', & 
                        'HC5A           ','H2O2           ','ICHOO          ', & 
                        'Cl2            ','ATOOH          ','PROPNN         ', & 
                        'MCRHN          ','MONITU         ','R4N1           ', & 
                        'PRN1           ','IONO           ','MVKOHOO        ', & 
                        ...
                        'HOI            ','ISOP           ','LIMO2          ', & 
                        'KO2            ','IONO2          ','IEPOXAOO       ', & 
                        'IEPOXBOO       ','MCRHP          ','MVKHP          ', & 
                        'CH3CHOO        ','PIO2           ','IDHNBOO        ', & 
                        'MGLY           ','A3O2           ','GLYC           ', & 
                        'HNO3           ','HOCl           ','ClNO2          ', & 
                        'ICN            ','MVKN           ','ITHN           ', & 
                        'IDN            ','IHOO4          ','IHOO1          ', & 
