...
!--------------------------------------------------------------------
      ...
      rate(:,:,293) = rate(:,:,293) * inv(:,:, 2)
      rate(:,:,294) = rate(:,:,294) * inv(:,:, 2)
      rate(:,:,300) = rate(:,:,300) * inv(:,:, 2)
      rate(:,:,305) = rate(:,:,305) * inv(:,:, 2)
      ...
      rate(:,:,572) = rate(:,:,572) * inv(:,:, 1)
      rate(:,:,573) = rate(:,:,573) * inv(:,:, 1)
      rate(:,:,574) = rate(:,:,574) * inv(:,:, 1)
      rate(:,:,575) = rate(:,:,575) * inv(:,:, 1)
      rate(:,:,576) = rate(:,:,576) * inv(:,:, 1)
      rate(:,:,577) = rate(:,:,577) * inv(:,:, 1)
      rate(:,:,578) = rate(:,:,578) * inv(:,:, 1)
      rate(:,:,579) = rate(:,:,579) * inv(:,:, 1)
      rate(:,:,580) = rate(:,:,580) * inv(:,:, 1)
      rate(:,:,581) = rate(:,:,581) * inv(:,:, 1)
      rate(:,:,582) = rate(:,:,582) * inv(:,:, 1)
      rate(:,:,583) = rate(:,:,583) * inv(:,:, 1)
      rate(:,:,584) = rate(:,:,584) * inv(:,:, 1)
      rate(:,:,353) = rate(:,:,353) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:,101) = rate(:,:,101) * m(:,:)
      rate(:,:,102) = rate(:,:,102) * m(:,:)
      rate(:,:,103) = rate(:,:,103) * m(:,:)
      rate(:,:,104) = rate(:,:,104) * m(:,:)
