      ...
      do k = 1,avec_len
         ...
         mat(k,1700) = rxt(k,215)*y(k,19) + (4.000_r8*rxt(k,182)+2.000_r8*rxt(k,184)) &
                      *y(k,59) + rxt(k,186)*y(k,124) + rxt(k,191)*y(k,133) &
                      + rxt(k,469)*y(k,150) + rxt(k,181)*y(k,196) + rxt(k,192) &
                      *y(k,212)
         ...
         mat(k,232) = rxt(k,474)*y(k,150)
         mat(k,1088) = mat(k,1088) + rxt(k,474)*y(k,136)
         ...
         mat(k,1876) = rxt(k,256)*y(k,42) + rxt(k,464)*y(k,137)
         ...
         mat(k,253) = rxt(k,464)*y(k,133) + rxt(k,465)*y(k,212)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,193) = -(rxt(k,462)*y(k,126) + (rxt(k,463) + rxt(k,476)) * y(k,212))
         mat(k,1407) = -rxt(k,462)*y(k,67)
         mat(k,1515) = -(rxt(k,463) + rxt(k,476)) * y(k,67)
         ...
         mat(k,255) = rxt(k,465)*y(k,212)
         mat(k,399) = rxt(k,470)*y(k,212)
         mat(k,1085) = rxt(k,475)*y(k,212)
         ...
         mat(k,167) = rxt(k,478)*y(k,222)
         mat(k,1998) = rxt(k,478)*y(k,152)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,49) = -(rxt(k,479)*y(k,212))
         mat(k,1492) = -rxt(k,479)*y(k,120)
         ...
         mat(k,1781) = 2.000_r8*rxt(k,152)*y(k,112) + rxt(k,155)*y(k,133) + rxt(k,471) &
                      *y(k,150)
         mat(k,1895) = mat(k,1895) + rxt(k,155)*y(k,125)
         mat(k,1094) = rxt(k,471)*y(k,125)
         ...
         mat(k,1776) = -((rxt(k,151) + rxt(k,152) + rxt(k,153)) * y(k,112) + (rxt(k,155) &
                      ...
                      *y(k,208) + rxt(k,422)*y(k,141) + rxt(k,425)*y(k,188) + rxt(k,471) &
                      *y(k,150))
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,401) = -rxt(k,467)*y(k,134)
         mat(k,1091) = -rxt(k,473)*y(k,134)
         ...
         mat(k,229) = -(rxt(k,474)*y(k,150))
         mat(k,1080) = -rxt(k,474)*y(k,136)
         mat(k,1844) = rxt(k,214)*y(k,59)
         mat(k,1685) = rxt(k,214)*y(k,19) + 2.000_r8*rxt(k,184)*y(k,59)
         mat(k,250) = -(rxt(k,464)*y(k,133) + rxt(k,465)*y(k,212))
         mat(k,1867) = -rxt(k,464)*y(k,137)
         mat(k,1524) = -rxt(k,465)*y(k,137)
         ...
         mat(k,397) = -(rxt(k,467)*y(k,134) + rxt(k,470)*y(k,212))
         mat(k,1791) = -rxt(k,467)*y(k,148)
         mat(k,1545) = -rxt(k,470)*y(k,148)
         mat(k,1083) = -(rxt(k,468)*y(k,19) + rxt(k,469)*y(k,59) + rxt(k,471)*y(k,125) &
                      + rxt(k,473)*y(k,134) + rxt(k,474)*y(k,136) + rxt(k,475) &
                      *y(k,212))
         mat(k,1848) = -rxt(k,468)*y(k,150)
         mat(k,1689) = -rxt(k,469)*y(k,150)
         mat(k,1762) = -rxt(k,471)*y(k,150)
         mat(k,1818) = -rxt(k,473)*y(k,150)
         mat(k,231) = -rxt(k,474)*y(k,150)
         mat(k,1607) = -rxt(k,475)*y(k,150)
         mat(k,1878) = rxt(k,464)*y(k,137)
         mat(k,1818) = mat(k,1818) + rxt(k,467)*y(k,148)
         mat(k,254) = rxt(k,464)*y(k,133)
         mat(k,398) = rxt(k,467)*y(k,134) + rxt(k,470)*y(k,212)
         mat(k,1607) = mat(k,1607) + rxt(k,470)*y(k,148)
         mat(k,726) = -(rxt(k,477)*y(k,212))
         mat(k,1580) = -rxt(k,477)*y(k,151)
         mat(k,1847) = rxt(k,468)*y(k,150)
         mat(k,1687) = rxt(k,469)*y(k,150)
         mat(k,194) = rxt(k,462)*y(k,126) + (rxt(k,463)+.500_r8*rxt(k,476))*y(k,212)
         mat(k,1755) = rxt(k,471)*y(k,150)
         mat(k,1412) = rxt(k,462)*y(k,67)
         mat(k,1798) = rxt(k,473)*y(k,150)
         mat(k,230) = rxt(k,474)*y(k,150)
         mat(k,252) = rxt(k,465)*y(k,212)
         mat(k,1082) = rxt(k,468)*y(k,19) + rxt(k,469)*y(k,59) + rxt(k,471)*y(k,125) &
                      + rxt(k,473)*y(k,134) + rxt(k,474)*y(k,136) + rxt(k,475) &
                      *y(k,212)
         mat(k,1580) = mat(k,1580) + (rxt(k,463)+.500_r8*rxt(k,476))*y(k,67) &
                      + rxt(k,465)*y(k,137) + rxt(k,475)*y(k,150)
         mat(k,168) = -(rxt(k,478)*y(k,222))
         mat(k,2000) = -rxt(k,478)*y(k,152)
         mat(k,725) = rxt(k,477)*y(k,212)
         mat(k,1512) = rxt(k,477)*y(k,151)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,108) = .0738005_r8*rxt(k,506)*y(k,212)
         ...
         mat(k,1489) = .114_r8*rxt(k,496)*y(k,6) + .1621005_r8*rxt(k,497)*y(k,7) &
                      ...
                      *y(k,104) + .1278005_r8*rxt(k,504)*y(k,110) &
                      + .0128005_r8*rxt(k,505)*y(k,172) + .0738005_r8*rxt(k,506) &
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,196) = .500_r8*rxt(k,476)*y(k,212)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,198) = -(rxt(k,463) + rxt(k,476)) * y(k,212)
         mat(k,256) = -rxt(k,465)*y(k,212)
         mat(k,400) = -rxt(k,470)*y(k,212)
         mat(k,1087) = -rxt(k,475)*y(k,212)
         mat(k,729) = -rxt(k,477)*y(k,212)
         mat(k,50) = -rxt(k,479)*y(k,212)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,2022) = -(rxt(k,125)*y(k,211) + rxt(k,233)*y(k,73) + rxt(k,478) &
                      *y(k,152))
         mat(k,1484) = -rxt(k,125)*y(k,222)
         mat(k,656) = -rxt(k,233)*y(k,222)
         mat(k,171) = -rxt(k,478)*y(k,222)
