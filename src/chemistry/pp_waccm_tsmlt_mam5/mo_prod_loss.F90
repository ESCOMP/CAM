...
!--------------------------------------------------------------------
      do k = ofl,ofu
         loss(k,1) = ( + het_rates(k,189))* y(k,189)
         prod(k,1) = 0._r8
...
!--------------------------------------------------------------------
      do k = 1,avec_len
         ...
         prod(k,26) = 0._r8
         loss(k,27) = ( + het_rates(k,157))* y(k,157)
         prod(k,27) = 0._r8
         loss(k,28) = ( + het_rates(k,158))* y(k,158)
         prod(k,28) = 0._r8
         loss(k,29) = ( + rxt(k,141) + het_rates(k,159))* y(k,159)
         prod(k,29) = 0._r8
         loss(k,30) = ( + rxt(k,142) + het_rates(k,160))* y(k,160)
         prod(k,30) = 0._r8
         loss(k,31) = ( + rxt(k,143) + het_rates(k,161))* y(k,161)
         prod(k,31) = 0._r8
         loss(k,32) = ( + rxt(k,144) + het_rates(k,162))* y(k,162)
         prod(k,32) = 0._r8
         loss(k,33) = ( + rxt(k,145) + het_rates(k,163))* y(k,163)
         prod(k,33) = 0._r8
         loss(k,34) = ( + rxt(k,146) + het_rates(k,164))* y(k,164)
         prod(k,34) = 0._r8
         loss(k,35) = ( + rxt(k,147) + het_rates(k,165))* y(k,165)
         prod(k,35) = 0._r8
         loss(k,36) = ( + rxt(k,148) + het_rates(k,166))* y(k,166)
         prod(k,36) = 0._r8
         loss(k,37) = ( + rxt(k,149) + het_rates(k,167))* y(k,167)
         prod(k,37) = 0._r8
