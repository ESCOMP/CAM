...
!--------------------------------------------------------------
      ...
      ! solsym contains, in order, GEOS-Chem advected species, MAM aerosols (33), CO2 (1),
      ! and GEOS-Chem non-advected species. The order must match exactly as specified in
      ! geoschem_config.yml. (hplin, 6/24/24)
      solsym(:357) = (/ &
      'ACET           ', 'ACTA           ', 'AERI           ', &
      'ALD2           ', 'ALK4           ', 'AONITA         ', &
      'AROMP4         ', 'AROMP5         ', 'ASOA1          ', &
