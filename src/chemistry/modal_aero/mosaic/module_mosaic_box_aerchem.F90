...
!       uptkrate_h2so4,         gam_ratio,    jaerosolstate_bgn                   )
    ...
    use module_data_mosaic_aero, only:                                             &
         ...
         Nmax_mesa, nmax_ASTEM, mosaic_vars_aa_type, jc_h ! add jc_h to save aerosol pH (dsj)
...
! bound temperature between 220 and 330 K  ! 6/3/2015 RAZ
    ...
    ! liquid-liquid
    Keq_ll(1)= fn_Keq(1.0502E-2_r8, 8.85d0, 25.14d0,T_K)      ! HSO4- <=> SO4= + H+
    Keq_ll(2)= fn_Keq(1.805E-5_r8, -1.50d0, 26.92d0,T_K)      ! NH3(l) + H2O = NH4+ + OH-
    Keq_ll(3)= fn_Keq(1.01E-14_r8,-22.52d0, 26.92d0,T_K)      ! H2O(l) <=> H+ + OH-
    ...
    ! solid-gas
    Keq_sg(1)= fn_Keq(4.72E-17_r8,-74.38d0,6.12d0,T_K)/rt**2  ! NH4NO3<=>NH3(g)+HNO3(g)
    Keq_sg(2)= fn_Keq(8.43E-17_r8,-71.00d0,2.40d0,T_K)/rt**2  ! NH4Cl <=>NH3(g)+HCl(g)
    ...
    Po_soa(iaro1_g) = fn_Po(5.7E-5_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(iaro2_g) = fn_Po(1.6E-3_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(ialk1_g) = fn_Po(5.0E-6_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(iole1_g) = fn_Po(5.0E-6_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(iapi1_g) = fn_Po(4.0E-6_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(iapi2_g) = fn_Po(1.7E-4_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(ilim1_g) = fn_Po(2.5E-5_r8, 156.0d0, T_K) ! [Pascal]
    Po_soa(ilim2_g) = fn_Po(1.2E-4_r8, 156.0d0, T_K) ! [Pascal]
...
!       Po_soa(ilim2_g) = fn_Po(1.0E-10_r8, 156.0d0, T_K) ! [Pascal]
...
!           * exp( (-156.0d0/8.3144d-3)*((1.0d0/t_k) - (1.0d0/298.0d0)) )  ! [Pascal]
       ...
       Po_soa(ilim2_g) = fn_Po(9.9127E-8_r8, 153.0d0, T_K) ! [Pascal]
       sat_soa(ilim2_g) = 1.e9_r8*Po_soa(ilim2_g)/(8.314_r8*T_K)

!zlu soa   
       Po_soa(ilim1_g) = fn_Po(9.9127E-7_r8, 142.0d0, T_K) ! [Pascal]
       sat_soa(ilim1_g) = 1.e9_r8*Po_soa(ilim1_g)/(8.314_r8*T_K)

       Po_soa(iaro1_g) = fn_Po(9.9127E-6_r8, 131.0d0, T_K) ! [Pascal]
       sat_soa(iaro1_g) = 1.e9_r8*Po_soa(iaro1_g)/(8.314_r8*T_K)

       Po_soa(iapi1_g) = fn_Po(9.9127E-5_r8, 120.0d0, T_K) ! [Pascal]
       sat_soa(iapi1_g) = 1.e9_r8*Po_soa(iapi1_g)/(8.314_r8*T_K)

       Po_soa(iapi2_g) = fn_Po(9.9127E-4_r8, 109.0d0, T_K) ! [Pascal]
