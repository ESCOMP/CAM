module module_data_mosaic_aero
  ...
  real(r8), parameter :: mass_cutoff = 1.e-6_r8	! new value on 02-mar-2010
  
  real(r8), parameter :: density_min_allow = 1.0_r8	! minimum allowed density (g/cc)
  real(r8), parameter :: density_max_allow = 3.0_r8	! maximum allowed density (g/cc)
  real(r8), parameter :: ah2o_max = 0.99_r8                ! maximum water activity allowed in aerosol water uptake calculations
