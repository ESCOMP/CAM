...
!--------------------------------------------------------------------
      ...
      rate(:,:, 290) = rate(:,:, 290) * inv(:,:, 2)
      rate(:,:, 294) = rate(:,:, 294) * inv(:,:, 1)
      ...
      rate(:,:, 456) = rate(:,:, 456) * inv(:,:, 2)
      rate(:,:, 462) = rate(:,:, 462) * inv(:,:, 2)
      rate(:,:, 121) = rate(:,:, 121) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 127) = rate(:,:, 127) * inv(:,:, 2) * inv(:,:, 1)
      rate(:,:, 114) = rate(:,:, 114) * m(:,:)
      rate(:,:, 115) = rate(:,:, 115) * m(:,:)
      rate(:,:, 118) = rate(:,:, 118) * m(:,:)
      rate(:,:, 119) = rate(:,:, 119) * m(:,:)
