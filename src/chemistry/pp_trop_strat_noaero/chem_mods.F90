...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: phtcnt = 113, & ! number of photolysis reactions
                            rxntot = 532, & ! number of total reactions
                            gascnt = 419, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 202, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 2050, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 171, & ! number of species in implicit class
