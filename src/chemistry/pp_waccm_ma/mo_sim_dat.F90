...
!--------------------------------------------------------------
      ...
      permute(: 50,4) = (/    8,  45,  16,  35,  44,  11,   6,   1,  39,  30, &
                             17,   2,   7,  26,  36,  49,  19,  29,  34,   9, &
                             31,  40,  12,  22,  28,  27,  10,  37,  41,  48, &
                             47,  32,  50,   3,  43,  38,  25,  15,  20,  24, &
                             18,  42,   4,   5,  23,  46,  21,  14,  13,  33 /)

      diag_map(: 50) = (/    1,   4,   7,  10,  13,  15,  17,  21,  24,  27, &
                            33,  39,  46,  53,  59,  64,  72,  76,  83,  91, &
                           102, 112, 120, 129, 144, 154, 167, 177, 184, 194, &
                           206, 226, 238, 254, 272, 288, 306, 332, 359, 385, &
                           411, 437, 458, 478, 502, 534, 574, 596, 617, 636 /)
      ...
      rxt_tag_lst(     1:   200) = (/ 'jh2o_b                          ', 'jh2o_c                          ', &
                                      ...
                                      'BRO_O                           ', 'BRO_OH                          ', &
                                      'HBR_O                           ', 'HBR_OH                          ' /)
      rxt_tag_lst(   201:   289) = (/ 'HOBR_O                          ', 'O1D_CF3BR                       ', &
                                      'O1D_CHBR3                       ', 'O1D_H2402                       ', &
                                      'O1D_HBRa                        ', 'O1D_HBRb                        ', &
                                      'F_CH4                           ', 'F_H2                            ', &
                                      'F_H2O                           ', 'F_HNO3                          ', &
