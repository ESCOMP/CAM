...
contains
   subroutine set_rates( rxt_rates, sol, ncol )
      ...
      rxt_rates(:ncol,:,   163) = rxt_rates(:ncol,:,   163)*sol(:ncol,:,    99)*sol(:ncol,:,   139)                            ! rate_const*NO3*HO2
      rxt_rates(:ncol,:,   164) = rxt_rates(:ncol,:,   164)*sol(:ncol,:,    99)*sol(:ncol,:,    97)                            ! rate_const*NO3*NO
      rxt_rates(:ncol,:,   165) = rxt_rates(:ncol,:,   165)*sol(:ncol,:,    99)*sol(:ncol,:,   106)                            ! rate_const*NO3*O
      rxt_rates(:ncol,:,   166) = rxt_rates(:ncol,:,   166)*sol(:ncol,:,    99)*sol(:ncol,:,   111)                            ! rate_const*NO3*OH
      rxt_rates(:ncol,:,   167) = rxt_rates(:ncol,:,   167)*sol(:ncol,:,    89)*sol(:ncol,:,   111)                            ! rate_const*N*OH
      rxt_rates(:ncol,:,   168) = rxt_rates(:ncol,:,   168)*sol(:ncol,:,    97)*sol(:ncol,:,   139)                            ! rate_const*NO*HO2
      rxt_rates(:ncol,:,   169) = rxt_rates(:ncol,:,   169)*sol(:ncol,:,    97)*sol(:ncol,:,   108)                            ! rate_const*NO*O3
      rxt_rates(:ncol,:,   170) = rxt_rates(:ncol,:,   170)*sol(:ncol,:,    97)*sol(:ncol,:,   106)                            ! rate_const*M*NO*O
      rxt_rates(:ncol,:,   171) = rxt_rates(:ncol,:,   171)*sol(:ncol,:,   144)*sol(:ncol,:,    90)                            ! rate_const*O1D*N2O
      rxt_rates(:ncol,:,   172) = rxt_rates(:ncol,:,   172)*sol(:ncol,:,   144)*sol(:ncol,:,    90)                            ! rate_const*O1D*N2O
      rxt_rates(:ncol,:,   173) = rxt_rates(:ncol,:,   173)*sol(:ncol,:,    98)*sol(:ncol,:,   139)                            ! rate_const*M*NO2*HO2
      rxt_rates(:ncol,:,   174) = rxt_rates(:ncol,:,   174)*sol(:ncol,:,    98)*sol(:ncol,:,    99)                            ! rate_const*M*NO2*NO3
