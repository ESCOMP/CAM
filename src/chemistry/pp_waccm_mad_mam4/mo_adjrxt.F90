...
!--------------------------------------------------------------------
      ...
      rate(:,:, 119) = rate(:,:, 119) * inv(:,:, 1)
      rate(:,:, 133) = rate(:,:, 133) * inv(:,:, 2)
      rate(:,:, 135) = rate(:,:, 135) * inv(:,:, 1)
      rate(:,:, 137) = rate(:,:, 137) * inv(:,:, 2)
      ...
      rate(:,:, 391) = rate(:,:, 391) * inv(:,:, 2)
      rate(:,:, 395) = rate(:,:, 395) * inv(:,:, 2)
      rate(:,:, 399) = rate(:,:, 399) * inv(:,:, 2)
