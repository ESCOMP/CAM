...
!--------------------------------------------------------------------
      if( class == 4 ) then
         ...
         prod(:,77) = 0._r8
         prod(:,71) = 0._r8
         prod(:,88) = (rxt(:,69) +rxt(:,70) +.800_r8*rxt(:,72) +.800_r8*rxt(:,73)) &
                  + extfrc(:,15)
         prod(:,42) = 0._r8
         prod(:,85) = 0._r8
         prod(:,8) = 0._r8
         ...
         prod(:,102) = 0._r8
         prod(:,108) = 0._r8
         prod(:,114) = (rxt(:,67) +rxt(:,68) +rxt(:,69) +rxt(:,70) +rxt(:,71) + &
                 rxt(:,74)) + extfrc(:,20)
         prod(:,55) = 0._r8
         prod(:,90) = 0._r8
         prod(:,110) = 0._r8
         ...
         prod(:,122) = 0._r8
         prod(:,72) = 0._r8
         prod(:,74) = (rxt(:,68) +rxt(:,71) +1.200_r8*rxt(:,72) +1.200_r8*rxt(:,73)) &
                  + extfrc(:,16)
         prod(:,64) = (rxt(:,67) +rxt(:,74)) + extfrc(:,17)
         prod(:,111) = 0._r8
         prod(:,95) = 0._r8
         prod(:,109) = 0._r8
         prod(:,100) = 0._r8
         ...
         prod(:,120) = 0._r8
         prod(:,68) = 0._r8
         prod(:,76) = (rxt(:,68) +rxt(:,69) +rxt(:,70) +rxt(:,71)) + extfrc(:,21)
         prod(:,83) = 0._r8
         prod(:,49) = 0._r8
         prod(:,125) = 0._r8
         prod(:,126) = + extfrc(:,23)
