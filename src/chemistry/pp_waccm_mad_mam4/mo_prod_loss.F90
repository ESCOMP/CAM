...
!--------------------------------------------------------------------
         ...
         prod(:,:,16) = 0._r8
         loss(:,:,17) = (rxt(:,:,504)* y(:,:,70) + rxt(:,:,51) + het_rates(:,:,42)) &
                 * y(:,:,42)
         prod(:,:,17) = 0._r8
         loss(:,:,18) = (rxt(:,:,527)* y(:,:,70) +rxt(:,:,522)* y(:,:,131) &
                  + rxt(:,:,53) + het_rates(:,:,46))* y(:,:,46)
         prod(:,:,18) = 0._r8
         loss(:,:,19) = (rxt(:,:,528)* y(:,:,70) +rxt(:,:,523)* y(:,:,131) &
                  + rxt(:,:,54) + het_rates(:,:,47))* y(:,:,47)
         prod(:,:,19) = 0._r8
         loss(:,:,20) = (rxt(:,:,529)* y(:,:,70) +rxt(:,:,524)* y(:,:,131) &
                  + rxt(:,:,55) + het_rates(:,:,48))* y(:,:,48)
         prod(:,:,20) = 0._r8
         loss(:,:,21) = ((rxt(:,:,442) +rxt(:,:,443))* y(:,:,70) + rxt(:,:,13) &
                  + het_rates(:,:,57))* y(:,:,57)
         prod(:,:,21) = 0._r8
         loss(:,:,22) = ( + rxt(:,:,61) + het_rates(:,:,78))* y(:,:,78)
         prod(:,:,22) = 0._r8
...
!--------------------------------------------------------------------
         ...
         prod(2) = 0._r8
         loss(75) = (rxt(486)* y(17) +rxt(488)* y(72) +rxt(487)* y(99) + het_rates(3)) &
                 * y(3)
         prod(75) = (rxt(28) +2.000_r8*rxt(489)*y(5) +rxt(490)*y(28) +rxt(491)*y(28) + &
         ...
         loss(41) = (rxt(496)* y(69) + rxt(29) + rxt(30) + rxt(565) + rxt(568) &
                  + rxt(573) + het_rates(6))* y(6)
         prod(41) =rxt(495)*y(63)*y(5)
         ...
         prod(83) = (rxt(457)*y(28) +rxt(534)*y(62))*y(21) + (rxt(23) + &
                 ...
                 *y(23)
         loss(65) = (rxt(457)* y(28) +rxt(534)* y(62) +rxt(533)* y(99) &
                  + het_rates(21))* y(21)
         prod(65) = (rxt(451)*y(25) +rxt(507)*y(39) +rxt(536)*y(131) +rxt(538)*y(70)) &
                 *y(23) +.700_r8*rxt(535)*y(131)*y(22)
         loss(35) = (rxt(535)* y(131) + rxt(23) + het_rates(22))* y(22)
         prod(35) =rxt(533)*y(99)*y(21)
         loss(93) = (rxt(513)* y(16) +rxt(450)* y(17) +rxt(515)* y(18) +rxt(518) &
         ...
         prod(93) = (4.000_r8*rxt(475)*y(8) +rxt(476)*y(9) +2.000_r8*rxt(477)*y(11) + &
         ...
         loss(113) = ((rxt(490) +rxt(491) +rxt(492))* y(5) +rxt(457)* y(21) &
         ...
         prod(113) = (rxt(455)*y(99) +rxt(456)*y(72) +rxt(472)*y(54))*y(25) &
                  + (rxt(48) +rxt(465)*y(69))*y(29) + (rxt(473)*y(69) + &
                 rxt(474)*y(131))*y(54) + (rxt(60) +rxt(554)*y(79))*y(73) &
                  +2.000_r8*rxt(485)*y(27) +rxt(483)*y(70)*y(49)
         loss(60) = (rxt(463)* y(25) + (rxt(569) +rxt(574) +rxt(579))* y(49) +rxt(465) &
                 * y(69) +rxt(466)* y(131) + rxt(47) + rxt(48) + rxt(567) + rxt(572) &
                  + rxt(578) + het_rates(29))* y(29)
         prod(60) =rxt(464)*y(63)*y(28)
         loss(49) = ((rxt(537) +rxt(541))* y(131) + het_rates(31))* y(31)
         prod(49) = (rxt(21) +rxt(22) +rxt(450)*y(25) +rxt(486)*y(3) +rxt(530)*y(64) + &
                 rxt(531)*y(69) +rxt(532)*y(131))*y(17) + (rxt(26) +rxt(62) + &
                 rxt(595)*y(134))*y(32) + (rxt(101) +rxt(544)*y(69) +rxt(545)*y(131)) &
                 *y(74) +rxt(518)*y(25)*y(20)
         ...
         prod(25) = (rxt(477)*y(11) +rxt(478)*y(12) +rxt(527)*y(46))*y(70) &
                  +rxt(522)*y(131)*y(46)
         loss(96) = (rxt(368)* y(116) +rxt(312)* y(121) +rxt(316)* y(125) +rxt(330) &
                 * y(128) +rxt(335)* y(129) +rxt(343)* y(132) +rxt(352)* y(133) &
                  +rxt(595)* y(134) + rxt(26) + rxt(62) + het_rates(32))* y(32)
         prod(96) = (rxt(63) +rxt(114)*y(25) +rxt(115)*y(25) +rxt(116)*y(28) + &
                 rxt(117)*y(40) +rxt(124)*y(51) +rxt(125)*y(69) +rxt(126)*y(71) + &
                 rxt(168)*y(105) +rxt(170)*y(103) +rxt(186)*y(101) +rxt(204)*y(120) + &
                 rxt(221)*y(117) +rxt(239)*y(116) +rxt(256)*y(126) +rxt(258)*y(103) + &
                 rxt(265)*y(105) +rxt(280)*y(62) +rxt(281)*y(63))*y(92) &
                  + (rxt(120)*y(63) +rxt(121)*y(63) +rxt(122)*y(62) +rxt(123)*y(62) + &
                 rxt(155)*y(126) +rxt(158)*y(103) +rxt(178)*y(105) +rxt(196)*y(101) + &
                 rxt(213)*y(120) +rxt(231)*y(117) +rxt(249)*y(116) +rxt(260)*y(103) + &
                 rxt(261)*y(105))*y(94) + (rxt(65) +rxt(127)*y(25) +rxt(128)*y(28) + &
                 rxt(130)*y(49) +rxt(132)*y(72) +rxt(151)*y(126) +rxt(174)*y(105) + &
                 rxt(191)*y(101) +rxt(209)*y(120) +rxt(225)*y(103) +rxt(227)*y(117) + &
                 rxt(244)*y(116))*y(95) + (rxt(153)*y(126) +rxt(176)*y(105) + &
                 rxt(194)*y(101) +rxt(211)*y(120) +rxt(229)*y(117) +rxt(246)*y(116) + &
                 rxt(247)*y(103) +rxt(259)*y(105) +rxt(271)*y(103))*y(93) &
                  + (rxt(149)*y(126) +rxt(172)*y(105) +rxt(189)*y(101) + &
                 rxt(203)*y(103) +rxt(207)*y(120) +rxt(224)*y(117) +rxt(242)*y(116)) &
                 *y(98) + (rxt(369) +rxt(306)*y(96) +rxt(307)*y(137))*y(119) &
                  + (rxt(537)*y(131) +rxt(541)*y(131))*y(31)
         loss(31) = (rxt(542)* y(64) + (rxt(543) +rxt(556))* y(131) + het_rates(35)) &
                 * y(35)
         prod(31) = 0._r8
         ...
         prod(53) = (rxt(480)*y(14) +rxt(502)*y(10) +2.000_r8*rxt(511)*y(33) + &
                 ...
                 *y(50)
         loss(99) = (rxt(411)* y(71) +rxt(414)* y(72) +rxt(105)* y(88) +rxt(117) &
         ...
         prod(99) = (rxt(141)*y(96) +rxt(147)*y(88) +rxt(158)*y(94) +rxt(162)*y(110) + &
                 rxt(163)*y(114) +rxt(164)*y(89) +rxt(165)*y(112) +rxt(166)*y(109) + &
                 rxt(170)*y(92) +rxt(181)*y(90) +rxt(203)*y(98) +rxt(214)*y(125) + &
                 rxt(225)*y(95) +rxt(236)*y(113) +rxt(247)*y(93) +rxt(258)*y(92) + &
                 rxt(260)*y(94) +rxt(262)*y(113) +rxt(271)*y(93))*y(103) &
                  + (rxt(144)*y(96) +rxt(168)*y(92) +rxt(169)*y(90) +rxt(172)*y(98) + &
                 rxt(173)*y(125) +rxt(174)*y(95) +rxt(175)*y(113) +rxt(176)*y(93) + &
                 rxt(177)*y(88) +rxt(178)*y(94) +rxt(179)*y(110) +rxt(180)*y(114) + &
                 rxt(182)*y(89) +rxt(183)*y(112) +rxt(184)*y(109) +rxt(259)*y(93) + &
                 rxt(261)*y(94) +rxt(263)*y(113) +rxt(265)*y(92))*y(105) &
                  + (rxt(186)*y(92) +rxt(187)*y(90) +rxt(189)*y(98) +rxt(190)*y(125) + &
                 rxt(191)*y(95) +rxt(193)*y(113) +rxt(194)*y(93) +rxt(195)*y(88) + &
                 rxt(196)*y(94) +rxt(197)*y(110) +rxt(198)*y(114) +rxt(199)*y(89) + &
                 rxt(200)*y(112) +rxt(201)*y(109) +rxt(383)*y(96))*y(101) &
                  + (rxt(415)*y(41) +rxt(418)*y(69) +rxt(438)*y(56) +rxt(532)*y(17) + &
                 rxt(541)*y(31) +rxt(545)*y(74) +rxt(550)*y(77) +rxt(555)*y(79)) &
                 *y(131) + (rxt(354)*y(133) +rxt(389)*y(70) +rxt(406)*y(69) + &
                 rxt(452)*y(25) +rxt(508)*y(39))*y(41) + (rxt(539)*y(23) + &
                 rxt(483)*y(49) +rxt(506)*y(45))*y(70) + (rxt(138)*y(97) + &
                 rxt(381)*y(106) +rxt(382)*y(100))*y(96) + (2.000_r8*rxt(2) +rxt(3)) &
                 *y(137) +2.000_r8*rxt(21)*y(17) +rxt(23)*y(22) +rxt(52)*y(45) &
                  +rxt(56)*y(49) +rxt(57)*y(50)
         ...
         prod(77) =rxt(22)*y(17) +rxt(540)*y(70)*y(23) +rxt(408)*y(99)*y(40) +rxt(1) &
                 *y(137)
         loss(42) = (rxt(453)* y(25) +rxt(407)* y(69) +rxt(416)* y(131) + rxt(4) &
                  + het_rates(43))* y(43)
         prod(42) = (.500_r8*rxt(559) +rxt(422)*y(99))*y(99) +rxt(421)*y(131)*y(131)
         ...
         loss(108) = ((rxt(569) +rxt(574) +rxt(579))* y(29) + (rxt(571) +rxt(576)) &
         ...
         prod(108) = (rxt(451)*y(23) +rxt(513)*y(16) +rxt(515)*y(18) + &
         ...
         prod(26) = (rxt(507)*y(23) +rxt(508)*y(41) +rxt(509)*y(137) +rxt(510)*y(51)) &
                 *y(39)
         loss(112) = (rxt(510)* y(39) +rxt(109)* y(88) +rxt(124)* y(92) +rxt(290) &
                 * y(109) +rxt(300)* y(111) +rxt(295)* y(113) +rxt(299)* y(114) &
                  +rxt(319)* y(125) +rxt(447)* y(131) +rxt(357)* y(133) + rxt(9) &
                  + het_rates(51))* y(51)
         prod(112) = (rxt(275) +2.000_r8*rxt(146)*y(103) +2.000_r8*rxt(167)*y(105) + &
                 ...
                 *y(58) + (rxt(567) +rxt(572) +rxt(578) +rxt(569)*y(49) + &
                 ...
                 rxt(143)*y(104))*y(137)
         loss(38) = (rxt(423)* y(131) + rxt(10) + rxt(11) + rxt(448) + het_rates(52)) &
                 * y(52)
         prod(38) =rxt(444)*y(99)*y(63)
         loss(55) = ((rxt(571) +rxt(576))* y(49) +rxt(501)* y(69) + rxt(58) &
                  + het_rates(53))* y(53)
         prod(55) = (rxt(565) +rxt(568) +rxt(573))*y(6) +rxt(493)*y(99)*y(5)
         ...
         prod(58) = (rxt(567) +rxt(572) +rxt(578) +rxt(466)*y(131))*y(29) &
                  +rxt(461)*y(99)*y(28)
         loss(52) = (rxt(340)* y(131) + rxt(12) + het_rates(55))* y(55)
         prod(52) = (rxt(289)*y(49) +rxt(290)*y(51))*y(109) +rxt(349)*y(131)*y(62) &
                  +rxt(305)*y(137)*y(118)
         loss(66) = (rxt(426)* y(62) + (rxt(427) +rxt(428) +rxt(429))* y(63) +rxt(430) &
                 * y(71) +rxt(592)* y(126) +rxt(438)* y(131) + rxt(66) &
                  + het_rates(56))* y(56)
         prod(66) = (rxt(424)*y(107) +rxt(589)*y(122))*y(69) &
                  + (.200_r8*rxt(583)*y(116) +1.100_r8*rxt(585)*y(108))*y(96) +rxt(17) &
                 *y(62) +rxt(590)*y(122)*y(71) +rxt(596)*y(134)
         loss(63) = (rxt(142)* y(103) +rxt(145)* y(105) +rxt(293)* y(112) +rxt(297) &
                 * y(113) + rxt(14) + rxt(15) + rxt(449) + rxt(560) + rxt(563) &
                  + rxt(566) + rxt(577) + het_rates(58))* y(58)
         prod(63) =rxt(445)*y(64)*y(63)
         ...
         prod(8) = 0._r8
         loss(102) = (rxt(494)* y(5) +rxt(534)* y(21) +rxt(462)* y(28) +rxt(426) &
                 * y(56) +rxt(435)* y(64) +rxt(441)* y(69) +rxt(440)* y(72) &
                  + (rxt(111) +rxt(112))* y(91) +rxt(280)* y(92) + (rxt(122) + &
                 rxt(123))* y(94) +rxt(439)* y(99) +rxt(594)* y(126) + (rxt(272) + &
                 rxt(279))* y(128) +rxt(349)* y(131) +rxt(136)* y(133) + rxt(16) &
                  + rxt(17) + het_rates(62))* y(62)
         prod(102) = (rxt(202)*y(115) +rxt(204)*y(92) +rxt(205)*y(90) + &
         ...
         loss(97) = (rxt(495)* y(5) +rxt(464)* y(28) + (rxt(427) +rxt(428) +rxt(429)) &
                 ...
                 * y(72) +rxt(551)* y(79) +rxt(110)* y(88) +rxt(281)* y(92) &
                  ...
                  + het_rates(63))* y(63)
         prod(97) = (rxt(112)*y(91) +rxt(136)*y(133) +2.000_r8*rxt(435)*y(64) + &
         ...
         loss(101) = (rxt(530)* y(17) +rxt(542)* y(35) +rxt(435)* y(62) +rxt(445) &
                 * y(63) +rxt(436)* y(69) +rxt(434)* y(99) +rxt(437)* y(131) + rxt(19) &
                  + rxt(20) + rxt(562) + het_rates(64))* y(64)
         prod(101) = (rxt(152)*y(126) +rxt(175)*y(105) +rxt(193)*y(101) + &
         ...
         prod(12) = 0._r8
         loss(100) = (rxt(497)* y(5) +rxt(496)* y(6) +rxt(531)* y(17) +rxt(467)* y(28) &
         ...
         prod(100) = (2.000_r8*rxt(5) +rxt(6) +rxt(83) +rxt(85) +rxt(87) + &
                 ...
                 *y(94) + (rxt(99) +rxt(358) +rxt(350)*y(25) +rxt(359)*y(63) + &
                 ...
                 rxt(592)*y(126))*y(56) + (rxt(26) +rxt(62))*y(32) + (rxt(17) + &
                 rxt(272)*y(128))*y(62) + (rxt(583)*y(116) +1.150_r8*rxt(584)*y(126)) &
                 *y(96) +rxt(28)*y(5) +rxt(46)*y(28) +rxt(410)*y(99)*y(40) +rxt(15) &
                 *y(58) +rxt(18)*y(63) +rxt(19)*y(64) +rxt(391)*y(70) +rxt(8)*y(72) &
                  +rxt(60)*y(73) +rxt(102)*y(79) +rxt(103)*y(80) +rxt(104)*y(81) &
                  +rxt(597)*y(134)*y(107) +rxt(420)*y(131)*y(131) +rxt(600)*y(135) &
                  +rxt(605)*y(136) +rxt(2)*y(137)
         ...
         loss(107) = (rxt(411)* y(40) +rxt(430)* y(56) +rxt(405)* y(69) +rxt(392) &
                 ...
                 * y(135) + rxt(5) + rxt(6) + rxt(83) + rxt(84) + rxt(85) + rxt(86) &
                  ...
                  + het_rates(71))* y(71)
         prod(107) = (rxt(8) +rxt(132)*y(95) +rxt(134)*y(96) +rxt(292)*y(109) + &
                 ...
                 rxt(227)*y(117) +rxt(244)*y(116))*y(95) + (rxt(95) +rxt(277)*y(63) + &
                 rxt(279)*y(62) +rxt(330)*y(32) +rxt(331)*y(40))*y(128) + (rxt(387) + &
                 ...
                 *y(52) +rxt(429)*y(63)*y(56) +rxt(443)*y(70)*y(57) +rxt(20)*y(64) &
                  +rxt(388)*y(124)
         loss(105) = (rxt(488)* y(3) +rxt(456)* y(25) +rxt(414)* y(40) +rxt(440) &
         ...
         prod(105) = (rxt(324)*y(125) +rxt(338)*y(130) +rxt(405)*y(71))*y(69) &
         ...
         prod(14) = 0._r8
         loss(48) = (rxt(546)* y(71) +rxt(547)* y(72) +rxt(550)* y(131) &
                  + het_rates(77))* y(77)
         prod(48) =rxt(101)*y(74) +rxt(102)*y(79)
         loss(68) = (rxt(548)* y(5) +rxt(549)* y(28) +rxt(551)* y(63) +rxt(552)* y(71) &
                  +rxt(553)* y(72) +rxt(554)* y(73) +rxt(555)* y(131) + rxt(102) &
                  + het_rates(79))* y(79)
         prod(68) = (rxt(546)*y(71) +rxt(547)*y(72) +rxt(550)*y(131))*y(77) &
                  +rxt(544)*y(74)*y(69) +rxt(103)*y(80)
         loss(59) = (rxt(557)* y(131) + rxt(103) + het_rates(80))* y(80)
         prod(59) = (rxt(548)*y(5) +rxt(549)*y(28) +rxt(551)*y(63) +rxt(552)*y(71) + &
         ...
         loss(28) = (rxt(558)* y(137) + rxt(104) + het_rates(81))* y(81)
         prod(28) =rxt(100)*y(44) +rxt(557)*y(131)*y(80)
         ...
         prod(20) = 0._r8
         loss(85) = (rxt(105)* y(40) +rxt(108)* y(49) +rxt(109)* y(51) +rxt(110) &
         ...
         prod(85) = (rxt(114)*y(92) +rxt(127)*y(95) +rxt(285)*y(109) + &
         ...
         loss(61) = ((rxt(111) +rxt(112))* y(62) +rxt(113)* y(69) + het_rates(91)) &
                 * y(91)
         prod(61) = (rxt(128)*y(95) +rxt(315)*y(125) +rxt(342)*y(132))*y(28) &
                  +rxt(115)*y(92)*y(25)
         loss(91) = ((rxt(114) +rxt(115))* y(25) +rxt(116)* y(28) +rxt(117)* y(40) &
                  ...
                  + het_rates(92))* y(92)
         prod(91) = (rxt(330)*y(128) +rxt(352)*y(133))*y(32) + (rxt(64) +rxt(283)) &
                 *y(94) + (rxt(129)*y(40) +rxt(131)*y(69))*y(95)
         loss(70) = (rxt(194)* y(101) + (rxt(247) +rxt(271))* y(103) + (rxt(176) + &
                 rxt(259))* y(105) +rxt(246)* y(116) +rxt(229)* y(117) +rxt(211) &
                 * y(120) +rxt(153)* y(126) + rxt(284) + het_rates(93))* y(93)
         prod(70) =rxt(118)*y(137)*y(94)
         ...
         loss(86) = (rxt(127)* y(25) +rxt(128)* y(28) +rxt(129)* y(40) +rxt(130) &
                 ...
                 * y(95)
         prod(86) = (rxt(316)*y(125) +rxt(335)*y(129))*y(32)
         loss(92) = ((rxt(133) +rxt(135))* y(71) +rxt(134)* y(72) +rxt(138)* y(97) &
         ...
         prod(92) = (rxt(77) +rxt(78) +rxt(79) +rxt(80) +rxt(81) +rxt(82) + &
         ...
         loss(69) = (rxt(189)* y(101) +rxt(203)* y(103) +rxt(172)* y(105) +rxt(242) &
                 * y(116) +rxt(224)* y(117) +rxt(207)* y(120) +rxt(149)* y(126) &
                  + het_rates(98))* y(98)
         prod(69) =rxt(343)*y(132)*y(32)
         ...
         loss(45) = (rxt(382)* y(96) +rxt(374)* y(137) + rxt(373) + het_rates(100)) &
                 * y(100)
         prod(45) = (rxt(139)*y(97) +rxt(372)*y(106))*y(137) +rxt(375)*y(101)
         loss(109) = (rxt(195)* y(88) +rxt(199)* y(89) +rxt(187)* y(90) +rxt(186) &
         ...
         prod(109) = (rxt(305)*y(118) +rxt(374)*y(100))*y(137) +rxt(377)*y(103)
         loss(29) = (rxt(140)* y(137) + het_rates(102))* y(102)
         prod(29) =rxt(142)*y(103)*y(58)
         loss(106) = (rxt(142)* y(58) +rxt(147)* y(88) +rxt(164)* y(89) + (rxt(181) + &
                 ...
                 * y(103)
         prod(106) = (rxt(140)*y(102) +rxt(376)*y(101))*y(137) +rxt(379)*y(105)
         loss(30) = (rxt(143)* y(137) + het_rates(104))* y(104)
         prod(30) =rxt(145)*y(105)*y(58)
         loss(114) = (rxt(145)* y(58) +rxt(177)* y(88) +rxt(182)* y(89) + (rxt(169) + &
         ...
         prod(114) = (rxt(143)*y(104) +rxt(378)*y(103))*y(137)
         loss(50) = (rxt(381)* y(96) +rxt(372)* y(137) + het_rates(106))* y(106)
         prod(50) = (rxt(309)*y(40) +rxt(310)*y(99) +rxt(311)*y(131))*y(120) +rxt(373) &
                 *y(100) +rxt(328)*y(137)*y(127)
         loss(54) = (rxt(424)* y(69) +rxt(425)* y(71) +rxt(597)* y(134) &
                  + het_rates(107))* y(107)
         prod(54) = (.800_r8*rxt(583)*y(116) +.900_r8*rxt(585)*y(108))*y(96) &
                  +rxt(587)*y(108)*y(69)
         loss(43) = ((rxt(587) +rxt(588))* y(69) +rxt(586)* y(71) +rxt(585)* y(96) &
                  + het_rates(108))* y(108)
         prod(43) =rxt(600)*y(135) +rxt(605)*y(136)
         loss(89) = (rxt(285)* y(25) +rxt(286)* y(28) +rxt(287)* y(40) +rxt(289) &
         ...
         prod(89) = (rxt(110)*y(88) +rxt(278)*y(128) +rxt(320)*y(125) + &
         ...
         loss(74) = (rxt(299)* y(51) +rxt(198)* y(101) +rxt(163)* y(103) +rxt(180) &
                 * y(105) +rxt(251)* y(116) +rxt(233)* y(117) +rxt(216)* y(120) &
                  +rxt(157)* y(126) + het_rates(114))* y(114)
         prod(74) =rxt(276)*y(111)*y(49)
         ...
         loss(94) = (rxt(368)* y(32) +rxt(248)* y(88) +rxt(252)* y(89) +rxt(240) &
         ...
         prod(94) = (rxt(593) +rxt(592)*y(56) +rxt(594)*y(62))*y(126) +rxt(16)*y(62) &
                  +rxt(587)*y(108)*y(69) +rxt(591)*y(122)*y(71) +rxt(369)*y(119) &
                  +rxt(371)*y(121) +rxt(596)*y(134)
         loss(95) = (rxt(230)* y(88) +rxt(234)* y(89) +rxt(222)* y(90) +rxt(221) &
                 ...
                 * y(114) +rxt(220)* y(115) +rxt(226)* y(125) +rxt(367)* y(137) &
                  + het_rates(117))* y(117)
         prod(95) =rxt(366)*y(137)*y(120)
         loss(37) = (rxt(304)* y(96) +rxt(305)* y(137) + het_rates(118))* y(118)
         prod(37) =rxt(367)*y(137)*y(117)
         loss(47) = (rxt(306)* y(96) +rxt(307)* y(137) + rxt(369) + het_rates(119)) &
                 * y(119)
         prod(47) = (rxt(312)*y(121) +rxt(368)*y(116))*y(32)
         loss(98) = (rxt(309)* y(40) +rxt(212)* y(88) +rxt(217)* y(89) +rxt(205) &
                 ...
                 * y(120)
         prod(98) = (rxt(307)*y(119) +rxt(313)*y(121) +rxt(365)*y(116))*y(137)
         loss(46) = (rxt(312)* y(32) +rxt(384)* y(96) +rxt(313)* y(137) + rxt(371) &
                  + het_rates(121))* y(121)
         prod(46) =rxt(370)*y(116)
         loss(56) = (rxt(589)* y(69) + (rxt(590) +rxt(591))* y(71) + het_rates(122)) &
                 * y(122)
         prod(56) =rxt(66)*y(56) +rxt(597)*y(134)*y(107) +rxt(606)*y(136)
         loss(62) = (rxt(396)* y(69) +rxt(397)* y(71) +rxt(321)* y(125) +rxt(339) &
                 * y(130) +rxt(361)* y(133) + rxt(387) + rxt(395) + het_rates(123)) &
                 * y(123)
         prod(62) = (rxt(399) +rxt(398)*y(32) +rxt(400)*y(69) +rxt(401)*y(71) + &
                 rxt(402)*y(72))*y(124) +rxt(7)*y(72)
         loss(32) = (rxt(398)* y(32) +rxt(400)* y(69) +rxt(401)* y(71) +rxt(402) &
                 * y(72) + rxt(388) + rxt(399) + het_rates(124))* y(124)
         prod(32) =rxt(392)*y(71)*y(70)
         loss(103) = (rxt(314)* y(25) +rxt(315)* y(28) +rxt(316)* y(32) +rxt(317) &
         ...
         prod(103) = (rxt(125)*y(92) +rxt(334)*y(128))*y(69) + (rxt(133)*y(96) + &
                 rxt(135)*y(96))*y(71) +rxt(65)*y(95) +rxt(97)*y(129)
         loss(104) = (rxt(592)* y(56) +rxt(594)* y(62) +rxt(364)* y(71) +rxt(154) &
                 ...
                 * y(115) +rxt(150)* y(125) +rxt(329)* y(137) + rxt(593) &
                  + het_rates(126))* y(126)
         prod(104) = (rxt(84) +rxt(86) +rxt(586)*y(108) +rxt(590)*y(122) + &
         ...
         loss(51) = (rxt(326)* y(96) + (rxt(327) +rxt(328))* y(137) + rxt(94) &
                  + het_rates(127))* y(127)
         prod(51) = (rxt(329)*y(126) +rxt(337)*y(130))*y(137)
         loss(76) = (rxt(330)* y(32) +rxt(331)* y(40) + (rxt(272) +rxt(279))* y(62) &
                  + (rxt(277) +rxt(278))* y(63) + (rxt(333) +rxt(334))* y(69) &
                  +rxt(332)* y(72) + rxt(95) + rxt(96) + het_rates(128))* y(128)
         prod(76) = (rxt(132)*y(95) +rxt(323)*y(125) +rxt(348)*y(132) + &
                 rxt(363)*y(133))*y(72) + (rxt(126)*y(92) +rxt(362)*y(133))*y(71) &
                  +rxt(336)*y(129)*y(69)
         loss(44) = (rxt(335)* y(32) +rxt(336)* y(69) + rxt(97) + het_rates(129)) &
                 * y(129)
         prod(44) =rxt(322)*y(125)*y(71)
         loss(67) = (rxt(338)* y(69) +rxt(380)* y(96) +rxt(339)* y(123) +rxt(337) &
                 * y(137) + het_rates(130))* y(130)
         prod(67) =rxt(364)*y(126)*y(71)
         loss(90) = (rxt(498)* y(5) +rxt(514)* y(16) +rxt(532)* y(17) +rxt(516)* y(18) &
         ...
         prod(90) = (rxt(406)*y(41) +rxt(407)*y(43) +rxt(412)*y(99) +rxt(470)*y(49) + &
                 ...
                 *y(40) +2.000_r8*rxt(4)*y(43) +rxt(356)*y(133)*y(49) +rxt(10)*y(52) &
                  ...
                  +rxt(138)*y(97)*y(96)
         loss(110) = (rxt(341)* y(25) +rxt(342)* y(28) +rxt(343)* y(32) +rxt(344) &
                 * y(40) +rxt(345)* y(49) +rxt(346)* y(63) +rxt(347)* y(69) +rxt(348) &
                 * y(72) + rxt(98) + het_rates(132))* y(132)
         prod(110) = (rxt(117)*y(92) +rxt(287)*y(109) +rxt(331)*y(128))*y(40) &
                  + (rxt(354)*y(41) +rxt(355)*y(137))*y(133)
         loss(111) = (rxt(350)* y(25) +rxt(351)* y(28) +rxt(352)* y(32) + (rxt(353) + &
                 rxt(354))* y(41) +rxt(356)* y(49) +rxt(357)* y(51) +rxt(136)* y(62) &
                  ...
                  + het_rates(133))* y(133)
         prod(111) =rxt(325)*y(125)*y(69) +rxt(134)*y(96)*y(72) +rxt(63)*y(92) &
                  +rxt(95)*y(128)
         loss(64) = (rxt(595)* y(32) +rxt(598)* y(71) +rxt(597)* y(107) + rxt(596) &
                  + het_rates(134))* y(134)
         prod(64) = (rxt(77) +rxt(81) +rxt(588)*y(108) +rxt(589)*y(122) + &
                 rxt(601)*y(135) +rxt(607)*y(136))*y(69) + (rxt(85) +rxt(87))*y(71) &
                  + (rxt(599)*y(135) +rxt(604)*y(136))*y(96) +rxt(581)*y(135) &
                  +rxt(580)*y(136)
         loss(40) = (rxt(601)* y(69) +rxt(602)* y(71) +rxt(599)* y(96) + rxt(581) &
                  + rxt(600) + het_rates(135))* y(135)
         prod(40) = (rxt(78) +rxt(82))*y(69) + (rxt(83) +rxt(92))*y(71) + (rxt(582) + &
                 rxt(603)*y(96))*y(136)
         loss(39) = (rxt(607)* y(69) + (rxt(603) +rxt(604))* y(96) + rxt(580) &
                  + rxt(582) + rxt(605) + rxt(606) + het_rates(136))* y(136)
         prod(39) = (rxt(79) +rxt(80))*y(69) + (rxt(90) +rxt(91))*y(71)
         loss(115) = (rxt(509)* y(39) +rxt(390)* y(70) +rxt(558)* y(81) +rxt(107) &
                 ...
                 * y(130) +rxt(355)* y(133) + rxt(1) + rxt(2) + rxt(3) &
                  + het_rates(137))* y(137)
         prod(115) = (rxt(377) +4.000_r8*rxt(141)*y(96) +4.000_r8*rxt(146)*y(115) + &
