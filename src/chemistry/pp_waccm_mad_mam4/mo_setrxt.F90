...
!-------------------------------------------------------
      ...
      rate(:n,108) = 8.00e-14_r8
      rate(:n,109) = 3.90e-17_r8
      rate(:n,114) = 1.30e-16_r8
      rate(:n,116) = 1.00e-20_r8
      rate(:n,152) = 6.90e-12_r8
      rate(:n,168) = 5.00e-12_r8
      rate(:n,169) = 7.00e-13_r8
      rate(:n,304) = 1.0e-10_r8
      rate(:n,305) = 4.4e-10_r8
      rate(:n,306) = 4.0e-10_r8
      rate(:n,307) = 2.0e-10_r8
      rate(:n,308) = 1.0e-12_r8
      rate(:n,309) = 6.0e-11_r8
      ...
      rate(:n,106) = 8.00e-12_r8 * exp( -2060._r8 * itemp(:) )
      rate(:n,110) = 1.80e-15_r8 * exp( 45._r8 * itemp(:) )
      rate(:n,111) = 3.50e-11_r8 * exp( -135._r8 * itemp(:) )
      rate(:n,115) = 3.60e-18_r8 * exp( -220._r8 * itemp(:) )
      rate(:n,118) = 2.15e-11_r8 * exp( 110._r8 * itemp(:) )
      exp_fac(:) = exp( 55._r8 * itemp(:) )
      rate(:n,119) = 3.135e-11_r8 * exp_fac(:)
      rate(:n,120) = 1.65e-12_r8 * exp_fac(:)
      rate(:n,150) = 1.40e-10_r8 * exp( -470._r8 * itemp(:) )
      rate(:n,154) = 1.80e-11_r8 * exp( 180._r8 * itemp(:) )
      rate(:n,155) = 1.70e-12_r8 * exp( -940._r8 * itemp(:) )
      rate(:n,156) = 4.80e-11_r8 * exp( 250._r8 * itemp(:) )
      rate(:n,162) = 3.00e-11_r8 * exp( 200._r8 * itemp(:) )
      rate(:n,163) = 1.00e-14_r8 * exp( -490._r8 * itemp(:) )
      rate(:n,171) = 1.50e-11_r8 * exp( -3600._r8 * itemp(:) )
      rate(:n,172) = 2.10e-11_r8 * exp( 100._r8 * itemp(:) )
      rate(:n,177) = 3.30e-12_r8 * exp( 270._r8 * itemp(:) )
      rate(:n,178) = 3.00e-12_r8 * exp( -1500._r8 * itemp(:) )
      rate(:n,179) = 5.10e-12_r8 * exp( 210._r8 * itemp(:) )
