...
!-------------------------------------------------------
      ...
      rate(:,:,542) = 1.9e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,543) = 9.6e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,544) = 2.1e-11_r8 * exp( -2200._r8 * itemp(:,:) )
      rate(:,:,545) = 7.2e-14_r8 * exp( -1070._r8 * itemp(:,:) )
      rate(:,:,552) = 1.6e-13_r8 * exp( -2280._r8 * itemp(:,:) )
      rate(:,:,555) = 2.7e-11_r8 * exp( 335._r8 * itemp(:,:) )

      itemp(:,:) = 300._r8 * itemp(:,:)

      ko(:,:) = 7e-31_r8 * itemp(:,:)**2.6_r8
      kinf(:,:) = 3.6e-11_r8 * itemp(:,:)**0.1_r8
      call jpl( rate(1,1,349), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 4.4e-32_r8 * itemp(:,:)**1.3_r8
      kinf(:,:) = 7.5e-11_r8 * itemp(:,:)**(-0.2_r8)
      call jpl( rate(1,1,411), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 6.9e-31_r8 * itemp(:,:)**1._r8
      kinf(:,:) = 2.6e-11_r8
      call jpl( rate(1,1,421), m, 0.6_r8, ko, kinf, n )
      ...
      kinf(:,:) = 2.8e-11_r8
      call jpl( rate(1,1,446), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 1.8e-31_r8 * itemp(:,:)**3.4_r8
      kinf(:,:) = 1.5e-11_r8 * itemp(:,:)**1.9_r8
      call jpl( rate(1,1,464), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 1.9e-32_r8 * itemp(:,:)**3.6_r8
      kinf(:,:) = 3.7e-12_r8 * itemp(:,:)**1.6_r8
      call jpl( rate(1,1,484), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.2e-31_r8 * itemp(:,:)**3.2_r8
      kinf(:,:) = 6.9e-12_r8 * itemp(:,:)**2.9_r8
      call jpl( rate(1,1,495), m, 0.6_r8, ko, kinf, n )

      ko(:,:) = 5.9e-33_r8 * itemp(:,:)**1._r8
      kinf(:,:) = 1.1e-12_r8 * itemp(:,:)**(-1.3_r8)
      call jpl( rate(1,1,537), m, 0.6_r8, ko, kinf, n )
...
!-------------------------------------------------------
      ...
      rate(:,:kbot,395) = 1e-20_r8
      rate(:,:kbot,396) = 1.3e-16_r8
      rate(:,:kbot,400) = 8e-14_r8
      rate(:,:kbot,401) = 3.9e-17_r8
      rate(:,:kbot,408) = 6.9e-12_r8
      rate(:,:kbot,424) = 7e-13_r8
      rate(:,:kbot,425) = 5e-12_r8
      rate(:,:kbot,580) = 0.047_r8
      rate(:,:kbot,581) = 7.7e-05_r8
      rate(:,:kbot,582) = 0.171_r8
      rate(:,:kbot,586) = 6e-11_r8
      rate(:,:kbot,589) = 1e-12_r8
      rate(:,:kbot,590) = 4e-10_r8
      rate(:,:kbot,591) = 2e-10_r8
      rate(:,:kbot,592) = 1e-10_r8
      rate(:,:kbot,594) = 4.4e-10_r8
      rate(:,:kbot,597) = 1.3e-10_r8
      rate(:,:kbot,600) = 8e-10_r8
      rate(:,:kbot,601) = 5e-12_r8
      rate(:,:kbot,602) = 7e-10_r8
      rate(:,:kbot,605) = 4.8e-10_r8
      rate(:,:kbot,606) = 1e-10_r8
      rate(:,:kbot,607) = 4e-10_r8
      itemp(:ncol,:kbot) = 1._r8 / temp(:ncol,:kbot)
      n = ncol*kbot
      rate(:,:kbot,391) = 2.15e-11_r8 * exp( 110._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( 55._r8 * itemp(:,:) )
      rate(:,:kbot,392) = 2.64e-11_r8 * exp_fac(:,:)
      rate(:,:kbot,393) = 6.6e-12_r8 * exp_fac(:,:)
      rate(:,:kbot,397) = 3.6e-18_r8 * exp( -220._r8 * itemp(:,:) )
      rate(:,:kbot,399) = 1.8e-15_r8 * exp( 45._r8 * itemp(:,:) )
      rate(:,:kbot,402) = 3.5e-11_r8 * exp( -135._r8 * itemp(:,:) )
      rate(:,:kbot,403) = 8e-12_r8 * exp( -2060._r8 * itemp(:,:) )
      rate(:,:kbot,412) = 3e-11_r8 * exp( 200._r8 * itemp(:,:) )
      rate(:,:kbot,413) = 1e-14_r8 * exp( -490._r8 * itemp(:,:) )
      rate(:,:kbot,414) = 1.4e-10_r8 * exp( -470._r8 * itemp(:,:) )
      rate(:,:kbot,417) = 4.8e-11_r8 * exp( 250._r8 * itemp(:,:) )
      rate(:,:kbot,418) = 1.8e-11_r8 * exp( 180._r8 * itemp(:,:) )
      rate(:,:kbot,419) = 1.7e-12_r8 * exp( -940._r8 * itemp(:,:) )
      rate(:,:kbot,426) = 2.1e-11_r8 * exp( 100._r8 * itemp(:,:) )
      rate(:,:kbot,430) = 1.5e-11_r8 * exp( -3600._r8 * itemp(:,:) )
      rate(:,:kbot,431) = 5.1e-12_r8 * exp( 210._r8 * itemp(:,:) )
      rate(:,:kbot,439) = 3.3e-12_r8 * exp( 270._r8 * itemp(:,:) )
      rate(:,:kbot,440) = 3e-12_r8 * exp( -1500._r8 * itemp(:,:) )
