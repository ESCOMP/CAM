...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) = (rxt(:,413)*y(:,200) +rxt(:,416)*y(:,211) +rxt(:,419)*y(:,213) + &
                 rxt(:,423)*y(:,141))*y(:,124) +.500_r8*rxt(:,352)*y(:,218)*y(:,108) &
                  +.200_r8*rxt(:,448)*y(:,216)*y(:,123) +.500_r8*rxt(:,460)*y(:,178) &
                 *y(:,125)
         prod(:,2) =rxt(:,480)*y(:,218)*y(:,119) +rxt(:,488)*y(:,120)
!--------------------------------------------------------------------
