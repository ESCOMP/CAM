      ...
      do k = 1,avec_len
         ...
         prod(k,125) = (4.000_r8*rxt(k,475)*y(k,8) +rxt(k,476)*y(k,9) + &
                 ...
                 rxt(k,230)*y(k,119) +rxt(k,248)*y(k,118))*y(k,90) &
                  + (rxt(k,159)*y(k,128) +rxt(k,164)*y(k,105) +rxt(k,182)*y(k,107) + &
                 rxt(k,199)*y(k,103) +rxt(k,217)*y(k,122) +rxt(k,234)*y(k,119) + &
         ...
         prod(k,121) = (rxt(k,63) +rxt(k,114)*y(k,25) +rxt(k,115)*y(k,25) + &
                 ...
                 rxt(k,258)*y(k,105) +rxt(k,265)*y(k,107) +rxt(k,280)*y(k,62) + &
                 rxt(k,281)*y(k,63))*y(k,94) + (rxt(k,120)*y(k,63) + &
                 rxt(k,121)*y(k,63) +rxt(k,122)*y(k,62) +rxt(k,123)*y(k,62) + &
                 rxt(k,155)*y(k,128) +rxt(k,158)*y(k,105) +rxt(k,178)*y(k,107) + &
                 rxt(k,196)*y(k,103) +rxt(k,213)*y(k,122) +rxt(k,231)*y(k,119) + &
                 rxt(k,249)*y(k,118) +rxt(k,260)*y(k,105) +rxt(k,261)*y(k,107)) &
                 *y(k,96) + (rxt(k,65) +rxt(k,127)*y(k,25) +rxt(k,128)*y(k,28) + &
                 rxt(k,130)*y(k,49) +rxt(k,132)*y(k,73) +rxt(k,151)*y(k,128) + &
                 rxt(k,174)*y(k,107) +rxt(k,191)*y(k,103) +rxt(k,209)*y(k,122) + &
                 rxt(k,225)*y(k,105) +rxt(k,227)*y(k,119) +rxt(k,244)*y(k,118)) &
                 *y(k,97) + (rxt(k,153)*y(k,128) +rxt(k,176)*y(k,107) + &
                 rxt(k,194)*y(k,103) +rxt(k,211)*y(k,122) +rxt(k,229)*y(k,119) + &
                 rxt(k,246)*y(k,118) +rxt(k,247)*y(k,105) +rxt(k,259)*y(k,107) + &
                 rxt(k,271)*y(k,105))*y(k,95) + (rxt(k,149)*y(k,128) + &
         ...
         loss(k,132) = (rxt(k,411)* y(k,72) +rxt(k,414)* y(k,73) +rxt(k,105)* y(k,90) &
                  +rxt(k,117)* y(k,94) +rxt(k,129)* y(k,97) + (rxt(k,408) + &
                 rxt(k,409) +rxt(k,410))* y(k,101) +rxt(k,287)* y(k,111) +rxt(k,309) &
                 * y(k,122) +rxt(k,317)* y(k,127) +rxt(k,331)* y(k,130) +rxt(k,344) &
                 * y(k,134) + het_rates(k,40))* y(k,40)
         prod(k,132) = (rxt(k,141)*y(k,98) +rxt(k,147)*y(k,90) +rxt(k,158)*y(k,96) + &
                 rxt(k,162)*y(k,112) +rxt(k,163)*y(k,116) +rxt(k,164)*y(k,91) + &
                 rxt(k,165)*y(k,114) +rxt(k,166)*y(k,111) +rxt(k,170)*y(k,94) + &
                 rxt(k,181)*y(k,92) +rxt(k,203)*y(k,100) +rxt(k,214)*y(k,127) + &
                 rxt(k,225)*y(k,97) +rxt(k,236)*y(k,115) +rxt(k,247)*y(k,95) + &
                 rxt(k,258)*y(k,94) +rxt(k,260)*y(k,96) +rxt(k,262)*y(k,115) + &
                 rxt(k,271)*y(k,95))*y(k,105) + (rxt(k,144)*y(k,98) + &
                 rxt(k,168)*y(k,94) +rxt(k,169)*y(k,92) +rxt(k,172)*y(k,100) + &
                 rxt(k,173)*y(k,127) +rxt(k,174)*y(k,97) +rxt(k,175)*y(k,115) + &
                 rxt(k,176)*y(k,95) +rxt(k,177)*y(k,90) +rxt(k,178)*y(k,96) + &
                 rxt(k,179)*y(k,112) +rxt(k,180)*y(k,116) +rxt(k,182)*y(k,91) + &
                 rxt(k,183)*y(k,114) +rxt(k,184)*y(k,111) +rxt(k,259)*y(k,95) + &
                 rxt(k,261)*y(k,96) +rxt(k,263)*y(k,115) +rxt(k,265)*y(k,94))*y(k,107) &
                  + (rxt(k,186)*y(k,94) +rxt(k,187)*y(k,92) +rxt(k,189)*y(k,100) + &
                 rxt(k,190)*y(k,127) +rxt(k,191)*y(k,97) +rxt(k,193)*y(k,115) + &
                 rxt(k,194)*y(k,95) +rxt(k,195)*y(k,90) +rxt(k,196)*y(k,96) + &
         ...
         prod(k,138) = (rxt(k,450)*y(k,17) +rxt(k,451)*y(k,23) +rxt(k,452)*y(k,41) + &
                 ...
                 2.000_r8*rxt(k,267)*y(k,105) +2.000_r8*rxt(k,268)*y(k,107))*y(k,92) &
                  + (rxt(k,157)*y(k,128) +rxt(k,163)*y(k,105) +rxt(k,180)*y(k,107) + &
         ...
         prod(k,137) = (rxt(k,202)*y(k,117) +rxt(k,204)*y(k,94) +rxt(k,205)*y(k,92) + &
                 ...
                 rxt(k,212)*y(k,90) +rxt(k,213)*y(k,96) +rxt(k,215)*y(k,112) + &
                 rxt(k,216)*y(k,116) +rxt(k,217)*y(k,91) +rxt(k,218)*y(k,114) + &
                 rxt(k,219)*y(k,111) +rxt(k,308)*y(k,98) +rxt(k,309)*y(k,40))*y(k,122) &
                  + (rxt(k,220)*y(k,117) +rxt(k,221)*y(k,94) +rxt(k,222)*y(k,92) + &
                 rxt(k,223)*y(k,113) +rxt(k,224)*y(k,100) +rxt(k,226)*y(k,127) + &
                 rxt(k,227)*y(k,97) +rxt(k,228)*y(k,115) +rxt(k,229)*y(k,95) + &
                 rxt(k,230)*y(k,90) +rxt(k,231)*y(k,96) +rxt(k,232)*y(k,112) + &
                 rxt(k,233)*y(k,116) +rxt(k,234)*y(k,91) +rxt(k,235)*y(k,114) + &
                 rxt(k,237)*y(k,111) +rxt(k,303)*y(k,98))*y(k,119) &
                  + (rxt(k,238)*y(k,117) +rxt(k,239)*y(k,94) +rxt(k,240)*y(k,92) + &
                 rxt(k,241)*y(k,113) +rxt(k,242)*y(k,100) +rxt(k,243)*y(k,127) + &
         ...
         prod(k,131) = (rxt(k,152)*y(k,128) +rxt(k,175)*y(k,107) + &
                 ...
                 rxt(k,236)*y(k,105) +rxt(k,245)*y(k,118) +rxt(k,262)*y(k,105) + &
                 rxt(k,263)*y(k,107))*y(k,115) + (rxt(k,160)*y(k,128) + &
                 rxt(k,165)*y(k,105) +rxt(k,183)*y(k,107) +rxt(k,200)*y(k,103) + &
                 rxt(k,218)*y(k,122) +rxt(k,235)*y(k,119) +rxt(k,253)*y(k,118)) &
                 *y(k,114) + (rxt(k,157)*y(k,128) +rxt(k,163)*y(k,105) + &
         ...
         prod(k,123) = (2.000_r8*rxt(k,5) +rxt(k,6) +rxt(k,83) +rxt(k,85) +rxt(k,87) + &
                 ...
                 *y(k,72) + (rxt(k,114)*y(k,25) +rxt(k,168)*y(k,107) + &
                 rxt(k,170)*y(k,105) +rxt(k,186)*y(k,103) +rxt(k,204)*y(k,122) + &
                 rxt(k,221)*y(k,119) +rxt(k,239)*y(k,118) +rxt(k,256)*y(k,128) + &
                 rxt(k,258)*y(k,105) +rxt(k,265)*y(k,107))*y(k,94) &
                  + (rxt(k,153)*y(k,128) +rxt(k,176)*y(k,107) +rxt(k,194)*y(k,103) + &
                 rxt(k,211)*y(k,122) +rxt(k,229)*y(k,119) +rxt(k,246)*y(k,118) + &
                 rxt(k,247)*y(k,105) +rxt(k,259)*y(k,107) +rxt(k,271)*y(k,105)) &
                 *y(k,95) + (rxt(k,155)*y(k,128) +rxt(k,158)*y(k,105) + &
                 rxt(k,178)*y(k,107) +rxt(k,196)*y(k,103) +rxt(k,213)*y(k,122) + &
         ...
         prod(k,124) = (rxt(k,8) +rxt(k,132)*y(k,97) +rxt(k,134)*y(k,98) + &
                 ...
                 *y(k,97) + (rxt(k,95) +rxt(k,277)*y(k,63) +rxt(k,279)*y(k,62) + &
                 rxt(k,330)*y(k,32) +rxt(k,331)*y(k,40))*y(k,130) + (rxt(k,387) + &
                 rxt(k,395) +2.000_r8*rxt(k,339)*y(k,132) + &
         ...
         prod(k,25) = 0._r8
         loss(k,109) = (rxt(k,105)* y(k,40) +rxt(k,108)* y(k,49) +rxt(k,109)* y(k,51) &
                  +rxt(k,110)* y(k,63) +rxt(k,195)* y(k,103) +rxt(k,147)* y(k,105) &
                  +rxt(k,177)* y(k,107) +rxt(k,248)* y(k,118) +rxt(k,230)* y(k,119) &
                  +rxt(k,212)* y(k,122) +rxt(k,154)* y(k,128) +rxt(k,107)* y(k,139) &
                  + het_rates(k,90))* y(k,90)
         prod(k,109) = (rxt(k,114)*y(k,94) +rxt(k,127)*y(k,97) +rxt(k,285)*y(k,111) + &
                 rxt(k,314)*y(k,127) +rxt(k,341)*y(k,134) +rxt(k,350)*y(k,135)) &
                 *y(k,25) + (rxt(k,130)*y(k,97) +rxt(k,289)*y(k,111) + &
                 rxt(k,298)*y(k,113) +rxt(k,318)*y(k,127) +rxt(k,345)*y(k,134) + &
                 rxt(k,356)*y(k,135))*y(k,49) + (rxt(k,116)*y(k,94) + &
                 rxt(k,286)*y(k,111) +rxt(k,351)*y(k,135))*y(k,28) &
                  + (rxt(k,112)*y(k,62) +rxt(k,113)*y(k,70))*y(k,93) +rxt(k,385) &
                 *y(k,91) +rxt(k,386)*y(k,92)
         loss(k,96) = (rxt(k,106)* y(k,49) +rxt(k,199)* y(k,103) +rxt(k,164)* y(k,105) &
                  +rxt(k,182)* y(k,107) +rxt(k,252)* y(k,118) +rxt(k,234)* y(k,119) &
                  +rxt(k,217)* y(k,122) +rxt(k,159)* y(k,128) + rxt(k,385) &
                  + het_rates(k,91))* y(k,91)
         prod(k,96) =rxt(k,107)*y(k,139)*y(k,90)
         loss(k,95) = (rxt(k,187)* y(k,103) + (rxt(k,181) +rxt(k,267))* y(k,105) &
                  + (rxt(k,169) +rxt(k,268))* y(k,107) +rxt(k,240)* y(k,118) &
                  +rxt(k,222)* y(k,119) +rxt(k,205)* y(k,122) +rxt(k,257)* y(k,128) &
                  + rxt(k,386) + het_rates(k,92))* y(k,92)
         prod(k,95) = (rxt(k,106)*y(k,91) +rxt(k,108)*y(k,90))*y(k,49)
         loss(k,84) = ((rxt(k,111) +rxt(k,112))* y(k,62) +rxt(k,113)* y(k,70) &
                  + het_rates(k,93))* y(k,93)
         prod(k,84) = (rxt(k,128)*y(k,97) +rxt(k,315)*y(k,127) +rxt(k,342)*y(k,134)) &
                 *y(k,28) +rxt(k,115)*y(k,94)*y(k,25)
         loss(k,115) = ((rxt(k,114) +rxt(k,115))* y(k,25) +rxt(k,116)* y(k,28) &
                  ...
                  +rxt(k,221)* y(k,119) +rxt(k,204)* y(k,122) +rxt(k,256)* y(k,128) &
                  +rxt(k,119)* y(k,139) + rxt(k,63) + het_rates(k,94))* y(k,94)
         prod(k,115) = (rxt(k,330)*y(k,130) +rxt(k,352)*y(k,135))*y(k,32) &
                  + (rxt(k,64) +rxt(k,283))*y(k,96) + (rxt(k,129)*y(k,40) + &
                 rxt(k,131)*y(k,70))*y(k,97)
         loss(k,94) = (rxt(k,194)* y(k,103) + (rxt(k,247) +rxt(k,271))* y(k,105) &
                  + (rxt(k,176) +rxt(k,259))* y(k,107) +rxt(k,246)* y(k,118) &
                  +rxt(k,229)* y(k,119) +rxt(k,211)* y(k,122) +rxt(k,153)* y(k,128) &
                  + rxt(k,284) + het_rates(k,95))* y(k,95)
         prod(k,94) =rxt(k,118)*y(k,139)*y(k,96)
         loss(k,104) = ((rxt(k,122) +rxt(k,123))* y(k,62) + (rxt(k,120) +rxt(k,121)) &
                 * y(k,63) +rxt(k,196)* y(k,103) + (rxt(k,158) +rxt(k,260))* y(k,105) &
                  + (rxt(k,178) +rxt(k,261))* y(k,107) +rxt(k,249)* y(k,118) &
                  +rxt(k,231)* y(k,119) +rxt(k,213)* y(k,122) +rxt(k,155)* y(k,128) &
                  +rxt(k,118)* y(k,139) + rxt(k,64) + rxt(k,283) + het_rates(k,96)) &
                 * y(k,96)
         prod(k,104) =rxt(k,119)*y(k,139)*y(k,94) +rxt(k,284)*y(k,95)
         loss(k,110) = (rxt(k,127)* y(k,25) +rxt(k,128)* y(k,28) +rxt(k,129)* y(k,40) &
                  +rxt(k,130)* y(k,49) +rxt(k,131)* y(k,70) +rxt(k,132)* y(k,73) &
                  +rxt(k,191)* y(k,103) +rxt(k,225)* y(k,105) +rxt(k,174)* y(k,107) &
                  +rxt(k,244)* y(k,118) +rxt(k,227)* y(k,119) +rxt(k,209)* y(k,122) &
                  +rxt(k,151)* y(k,128) + rxt(k,65) + het_rates(k,97))* y(k,97)
         prod(k,110) = (rxt(k,316)*y(k,127) +rxt(k,335)*y(k,131))*y(k,32)
         ...
         prod(k,116) = (rxt(k,77) +rxt(k,78) +rxt(k,79) +rxt(k,80) +rxt(k,81) + &
                 ...
                 rxt(k,347)*y(k,134) +rxt(k,360)*y(k,135))*y(k,70) + (rxt(k,83) + &
                 rxt(k,84) +rxt(k,85) +rxt(k,86) +rxt(k,87) +rxt(k,90) +rxt(k,91) + &
                 rxt(k,92))*y(k,72) + (rxt(k,99) +rxt(k,358) +rxt(k,136)*y(k,62) + &
                 rxt(k,353)*y(k,41) +rxt(k,361)*y(k,125))*y(k,135) + (rxt(k,93) + &
                 rxt(k,137) +rxt(k,317)*y(k,40) +rxt(k,321)*y(k,125))*y(k,127) &
                  + (rxt(k,105)*y(k,90) +rxt(k,344)*y(k,134))*y(k,40) + (rxt(k,96) + &
                 rxt(k,332)*y(k,73))*y(k,130) +rxt(k,66)*y(k,56) +rxt(k,16)*y(k,62) &
                  +rxt(k,75)*y(k,111) +rxt(k,76)*y(k,113) +rxt(k,98)*y(k,134)
         loss(k,57) = (rxt(k,138)* y(k,98) +rxt(k,139)* y(k,139) + het_rates(k,99)) &
                 * y(k,99)
         prod(k,57) =rxt(k,327)*y(k,139)*y(k,129)
         loss(k,93) = (rxt(k,189)* y(k,103) +rxt(k,203)* y(k,105) +rxt(k,172) &
         ...
         loss(k,130) = (rxt(k,142)* y(k,58) +rxt(k,147)* y(k,90) +rxt(k,164)* y(k,91) &
                 ...
                 * y(k,94) + (rxt(k,247) +rxt(k,271))* y(k,95) + (rxt(k,158) + &
                 rxt(k,260))* y(k,96) +rxt(k,225)* y(k,97) +rxt(k,141)* y(k,98) &
                  +rxt(k,203)* y(k,100) +rxt(k,166)* y(k,111) +rxt(k,162)* y(k,112) &
                  + (rxt(k,192) +rxt(k,264))* y(k,113) +rxt(k,165)* y(k,114) &
         ...
         loss(k,129) = (rxt(k,145)* y(k,58) +rxt(k,177)* y(k,90) +rxt(k,182)* y(k,91) &
                 ...
                 * y(k,94) + (rxt(k,176) +rxt(k,259))* y(k,95) + (rxt(k,178) + &
                 rxt(k,261))* y(k,96) +rxt(k,174)* y(k,97) +rxt(k,144)* y(k,98) &
                  +rxt(k,172)* y(k,100) +rxt(k,184)* y(k,111) +rxt(k,179)* y(k,112) &
                  + (rxt(k,171) +rxt(k,266))* y(k,113) +rxt(k,183)* y(k,114) &
         ...
         loss(k,113) = (rxt(k,285)* y(k,25) +rxt(k,286)* y(k,28) +rxt(k,287)* y(k,40) &
                  ...
                  +rxt(k,184)* y(k,107) +rxt(k,254)* y(k,118) +rxt(k,237)* y(k,119) &
                  +rxt(k,219)* y(k,122) +rxt(k,161)* y(k,128) +rxt(k,288)* y(k,139) &
                  + rxt(k,75) + het_rates(k,111))* y(k,111)
         prod(k,113) = (rxt(k,110)*y(k,90) +rxt(k,278)*y(k,130) +rxt(k,320)*y(k,127) + &
                 rxt(k,346)*y(k,134) +rxt(k,359)*y(k,135))*y(k,63) &
                  + (rxt(k,111)*y(k,93) +rxt(k,123)*y(k,96) +rxt(k,279)*y(k,130) + &
                 rxt(k,280)*y(k,94))*y(k,62) + (rxt(k,301)*y(k,70) + &
                 rxt(k,302)*y(k,73))*y(k,113) +rxt(k,273)*y(k,112)
         loss(k,97) = (rxt(k,197)* y(k,103) +rxt(k,162)* y(k,105) +rxt(k,179) &
                 * y(k,107) +rxt(k,250)* y(k,118) +rxt(k,232)* y(k,119) +rxt(k,215) &
                 * y(k,122) +rxt(k,156)* y(k,128) + rxt(k,273) + het_rates(k,112)) &
                 * y(k,112)
         prod(k,97) =rxt(k,122)*y(k,96)*y(k,62) +rxt(k,288)*y(k,139)*y(k,111)
         loss(k,111) = ((rxt(k,276) +rxt(k,298))* y(k,49) +rxt(k,300)* y(k,51) &
                  +rxt(k,301)* y(k,70) +rxt(k,302)* y(k,73) +rxt(k,188)* y(k,103) &
                  + (rxt(k,192) +rxt(k,264))* y(k,105) + (rxt(k,171) +rxt(k,266)) &
                 * y(k,107) +rxt(k,241)* y(k,118) +rxt(k,223)* y(k,119) +rxt(k,206) &
                 * y(k,122) +rxt(k,148)* y(k,128) +rxt(k,296)* y(k,139) + rxt(k,76) &
                  + het_rates(k,113))* y(k,113)
         prod(k,111) = (rxt(k,109)*y(k,90) +rxt(k,124)*y(k,94) +rxt(k,290)*y(k,111) + &
                 rxt(k,319)*y(k,127) +rxt(k,357)*y(k,135))*y(k,51) &
                  + (rxt(k,120)*y(k,96) +rxt(k,277)*y(k,130) +rxt(k,281)*y(k,94) + &
                 rxt(k,291)*y(k,111))*y(k,63) +rxt(k,272)*y(k,130)*y(k,62) &
                  +rxt(k,292)*y(k,111)*y(k,73) +rxt(k,282)*y(k,115) +rxt(k,275) &
                 *y(k,117)
         loss(k,102) = (rxt(k,293)* y(k,58) +rxt(k,200)* y(k,103) +rxt(k,165) &
                 * y(k,105) +rxt(k,183)* y(k,107) +rxt(k,253)* y(k,118) +rxt(k,235) &
                 * y(k,119) +rxt(k,218)* y(k,122) +rxt(k,160)* y(k,128) + rxt(k,274) &
                  + het_rates(k,114))* y(k,114)
         prod(k,102) =rxt(k,294)*y(k,139)*y(k,115)
         loss(k,105) = (rxt(k,295)* y(k,51) +rxt(k,297)* y(k,58) +rxt(k,193)* y(k,103) &
                  + (rxt(k,236) +rxt(k,262))* y(k,105) + (rxt(k,175) +rxt(k,263)) &
                 * y(k,107) +rxt(k,245)* y(k,118) +rxt(k,228)* y(k,119) +rxt(k,210) &
                 * y(k,122) +rxt(k,152)* y(k,128) +rxt(k,294)* y(k,139) + rxt(k,282) &
                  + het_rates(k,115))* y(k,115)
         prod(k,105) =rxt(k,121)*y(k,96)*y(k,63) +rxt(k,296)*y(k,139)*y(k,113) &
                  +rxt(k,274)*y(k,114)
         loss(k,98) = (rxt(k,299)* y(k,51) +rxt(k,198)* y(k,103) +rxt(k,163)* y(k,105) &
                  +rxt(k,180)* y(k,107) +rxt(k,251)* y(k,118) +rxt(k,233)* y(k,119) &
                  +rxt(k,216)* y(k,122) +rxt(k,157)* y(k,128) + het_rates(k,116)) &
                 * y(k,116)
         prod(k,98) =rxt(k,276)*y(k,113)*y(k,49)
         loss(k,101) = (rxt(k,185)* y(k,103) + (rxt(k,146) +rxt(k,269))* y(k,105) &
                  + (rxt(k,167) +rxt(k,270))* y(k,107) +rxt(k,238)* y(k,118) &
                  +rxt(k,220)* y(k,119) +rxt(k,202)* y(k,122) +rxt(k,255)* y(k,128) &
                  + rxt(k,275) + het_rates(k,117))* y(k,117)
         prod(k,101) = (rxt(k,295)*y(k,115) +rxt(k,299)*y(k,116) +rxt(k,300)*y(k,113)) &
         ...
         loss(k,119) = (rxt(k,230)* y(k,90) +rxt(k,234)* y(k,91) +rxt(k,222)* y(k,92) &
                  ...
                  +rxt(k,237)* y(k,111) +rxt(k,232)* y(k,112) +rxt(k,223)* y(k,113) &
                  +rxt(k,235)* y(k,114) +rxt(k,228)* y(k,115) +rxt(k,233)* y(k,116) &
                  +rxt(k,220)* y(k,117) +rxt(k,226)* y(k,127) +rxt(k,367)* y(k,139) &
                  + het_rates(k,119))* y(k,119)
         prod(k,119) =rxt(k,366)*y(k,139)*y(k,122)
         loss(k,58) = (rxt(k,304)* y(k,98) +rxt(k,305)* y(k,139) + het_rates(k,120)) &
                 * y(k,120)
         prod(k,58) =rxt(k,367)*y(k,139)*y(k,119)
         loss(k,71) = (rxt(k,306)* y(k,98) +rxt(k,307)* y(k,139) + rxt(k,369) &
                  + het_rates(k,121))* y(k,121)
         prod(k,71) = (rxt(k,312)*y(k,123) +rxt(k,368)*y(k,118))*y(k,32)
         loss(k,122) = (rxt(k,309)* y(k,40) +rxt(k,212)* y(k,90) +rxt(k,217)* y(k,91) &
                  +rxt(k,205)* y(k,92) +rxt(k,204)* y(k,94) +rxt(k,211)* y(k,95) &
                  +rxt(k,213)* y(k,96) +rxt(k,209)* y(k,97) +rxt(k,308)* y(k,98) &
                  +rxt(k,207)* y(k,100) +rxt(k,310)* y(k,101) +rxt(k,219)* y(k,111) &
                  +rxt(k,215)* y(k,112) +rxt(k,206)* y(k,113) +rxt(k,218)* y(k,114) &
                  +rxt(k,210)* y(k,115) +rxt(k,216)* y(k,116) +rxt(k,202)* y(k,117) &
                  +rxt(k,208)* y(k,127) +rxt(k,311)* y(k,133) +rxt(k,366)* y(k,139) &
                  + het_rates(k,122))* y(k,122)
         prod(k,122) = (rxt(k,307)*y(k,121) +rxt(k,313)*y(k,123) +rxt(k,365)*y(k,118)) &
                 *y(k,139)
         ...
         loss(k,85) = (rxt(k,396)* y(k,70) +rxt(k,397)* y(k,72) +rxt(k,321)* y(k,127) &
                  ...
                  + rxt(k,395) + het_rates(k,125))* y(k,125)
         prod(k,85) = (rxt(k,399) +rxt(k,398)*y(k,32) +rxt(k,400)*y(k,70) + &
                 rxt(k,401)*y(k,72) +rxt(k,402)*y(k,73))*y(k,126) +rxt(k,7)*y(k,73)
         loss(k,51) = (rxt(k,398)* y(k,32) +rxt(k,400)* y(k,70) +rxt(k,401)* y(k,72) &
                  +rxt(k,402)* y(k,73) + rxt(k,388) + rxt(k,399) + het_rates(k,126)) &
                 * y(k,126)
         prod(k,51) =rxt(k,392)*y(k,72)*y(k,71)
         loss(k,127) = (rxt(k,314)* y(k,25) +rxt(k,315)* y(k,28) +rxt(k,316)* y(k,32) &
                  +rxt(k,317)* y(k,40) +rxt(k,318)* y(k,49) +rxt(k,319)* y(k,51) &
                  +rxt(k,320)* y(k,63) + (rxt(k,324) +rxt(k,325))* y(k,70) +rxt(k,322) &
                 * y(k,72) +rxt(k,323)* y(k,73) +rxt(k,190)* y(k,103) +rxt(k,214) &
                 * y(k,105) +rxt(k,173)* y(k,107) +rxt(k,243)* y(k,118) +rxt(k,226) &
                 * y(k,119) +rxt(k,208)* y(k,122) +rxt(k,321)* y(k,125) +rxt(k,150) &
                 * y(k,128) + rxt(k,93) + rxt(k,137) + het_rates(k,127))* y(k,127)
         ...
         prod(k,75) = (rxt(k,329)*y(k,128) +rxt(k,337)*y(k,132))*y(k,139)
         loss(k,100) = (rxt(k,330)* y(k,32) +rxt(k,331)* y(k,40) + (rxt(k,272) + &
                 rxt(k,279))* y(k,62) + (rxt(k,277) +rxt(k,278))* y(k,63) &
                  + (rxt(k,333) +rxt(k,334))* y(k,70) +rxt(k,332)* y(k,73) + rxt(k,95) &
                  + rxt(k,96) + het_rates(k,130))* y(k,130)
         prod(k,100) = (rxt(k,132)*y(k,97) +rxt(k,323)*y(k,127) +rxt(k,348)*y(k,134) + &
                 rxt(k,363)*y(k,135))*y(k,73) + (rxt(k,126)*y(k,94) + &
                 rxt(k,362)*y(k,135))*y(k,72) +rxt(k,336)*y(k,131)*y(k,70)
         loss(k,67) = (rxt(k,335)* y(k,32) +rxt(k,336)* y(k,70) + rxt(k,97) &
                  + het_rates(k,131))* y(k,131)
         prod(k,67) =rxt(k,322)*y(k,127)*y(k,72)
         ...
         prod(k,134) = (rxt(k,117)*y(k,94) +rxt(k,287)*y(k,111) +rxt(k,331)*y(k,130)) &
                 *y(k,40) + (rxt(k,354)*y(k,41) +rxt(k,355)*y(k,139))*y(k,135)
         loss(k,135) = (rxt(k,350)* y(k,25) +rxt(k,351)* y(k,28) +rxt(k,352)* y(k,32) &
                  + (rxt(k,353) +rxt(k,354))* y(k,41) +rxt(k,356)* y(k,49) +rxt(k,357) &
                 * y(k,51) +rxt(k,136)* y(k,62) +rxt(k,359)* y(k,63) +rxt(k,360) &
                 * y(k,70) +rxt(k,362)* y(k,72) +rxt(k,363)* y(k,73) +rxt(k,361) &
                 * y(k,125) +rxt(k,355)* y(k,139) + rxt(k,99) + rxt(k,358) &
         ...
         loss(k,139) = (rxt(k,509)* y(k,39) +rxt(k,390)* y(k,71) +rxt(k,557)* y(k,82) &
                  ...
                  +rxt(k,372)* y(k,108) +rxt(k,288)* y(k,111) +rxt(k,296)* y(k,113) &
                  +rxt(k,294)* y(k,115) +rxt(k,365)* y(k,118) +rxt(k,367)* y(k,119) &
                  +rxt(k,305)* y(k,120) +rxt(k,307)* y(k,121) +rxt(k,366)* y(k,122) &
                  +rxt(k,313)* y(k,123) +rxt(k,329)* y(k,128) + (rxt(k,327) + &
                 rxt(k,328))* y(k,129) +rxt(k,337)* y(k,132) +rxt(k,355)* y(k,135) &
                  + rxt(k,1) + rxt(k,2) + rxt(k,3) + het_rates(k,139))* y(k,139)
         prod(k,139) = (rxt(k,377) +4.000_r8*rxt(k,141)*y(k,98) + &
                 4.000_r8*rxt(k,146)*y(k,117) +4.000_r8*rxt(k,147)*y(k,90) + &
                 5.000_r8*rxt(k,158)*y(k,96) +5.000_r8*rxt(k,162)*y(k,112) + &
                 4.000_r8*rxt(k,163)*y(k,116) +5.000_r8*rxt(k,164)*y(k,91) + &
                 6.000_r8*rxt(k,165)*y(k,114) +4.000_r8*rxt(k,166)*y(k,111) + &
                 4.000_r8*rxt(k,170)*y(k,94) +4.000_r8*rxt(k,181)*y(k,92) + &
                 4.000_r8*rxt(k,192)*y(k,113) +4.000_r8*rxt(k,203)*y(k,100) + &
                 4.000_r8*rxt(k,214)*y(k,127) +4.000_r8*rxt(k,225)*y(k,97) + &
                 5.000_r8*rxt(k,236)*y(k,115) +6.000_r8*rxt(k,247)*y(k,95) + &
                 4.000_r8*rxt(k,258)*y(k,94) +5.000_r8*rxt(k,260)*y(k,96) + &
                 5.000_r8*rxt(k,262)*y(k,115) +4.000_r8*rxt(k,264)*y(k,113) + &
                 4.000_r8*rxt(k,267)*y(k,92) +4.000_r8*rxt(k,269)*y(k,117) + &
                 6.000_r8*rxt(k,271)*y(k,95))*y(k,105) + (rxt(k,379) + &
                 5.000_r8*rxt(k,144)*y(k,98) +5.000_r8*rxt(k,167)*y(k,117) + &
                 5.000_r8*rxt(k,168)*y(k,94) +5.000_r8*rxt(k,169)*y(k,92) + &
                 5.000_r8*rxt(k,171)*y(k,113) +5.000_r8*rxt(k,172)*y(k,100) + &
                 5.000_r8*rxt(k,173)*y(k,127) +5.000_r8*rxt(k,174)*y(k,97) + &
                 6.000_r8*rxt(k,175)*y(k,115) +7.000_r8*rxt(k,176)*y(k,95) + &
                 5.000_r8*rxt(k,177)*y(k,90) +6.000_r8*rxt(k,178)*y(k,96) + &
                 6.000_r8*rxt(k,179)*y(k,112) +5.000_r8*rxt(k,180)*y(k,116) + &
                 6.000_r8*rxt(k,182)*y(k,91) +7.000_r8*rxt(k,183)*y(k,114) + &
                 5.000_r8*rxt(k,184)*y(k,111) +7.000_r8*rxt(k,259)*y(k,95) + &
                 6.000_r8*rxt(k,261)*y(k,96) +6.000_r8*rxt(k,263)*y(k,115) + &
                 5.000_r8*rxt(k,265)*y(k,94) +5.000_r8*rxt(k,266)*y(k,113) + &
                 5.000_r8*rxt(k,268)*y(k,92) +5.000_r8*rxt(k,270)*y(k,117))*y(k,107) &
                  + (rxt(k,375) +3.000_r8*rxt(k,185)*y(k,117) + &
                 3.000_r8*rxt(k,186)*y(k,94) +3.000_r8*rxt(k,187)*y(k,92) + &
                 3.000_r8*rxt(k,188)*y(k,113) +3.000_r8*rxt(k,189)*y(k,100) + &
                 3.000_r8*rxt(k,190)*y(k,127) +3.000_r8*rxt(k,191)*y(k,97) + &
                 4.000_r8*rxt(k,193)*y(k,115) +5.000_r8*rxt(k,194)*y(k,95) + &
                 3.000_r8*rxt(k,195)*y(k,90) +4.000_r8*rxt(k,196)*y(k,96) + &
                 4.000_r8*rxt(k,197)*y(k,112) +3.000_r8*rxt(k,198)*y(k,116) + &
                 ...
                 2.000_r8*rxt(k,227)*y(k,97) +3.000_r8*rxt(k,228)*y(k,115) + &
                 4.000_r8*rxt(k,229)*y(k,95) +2.000_r8*rxt(k,230)*y(k,90) + &
                 3.000_r8*rxt(k,231)*y(k,96) +3.000_r8*rxt(k,232)*y(k,112) + &
                 2.000_r8*rxt(k,233)*y(k,116) +3.000_r8*rxt(k,234)*y(k,91) + &
                 4.000_r8*rxt(k,235)*y(k,114) +2.000_r8*rxt(k,237)*y(k,111) + &
                 2.000_r8*rxt(k,303)*y(k,98))*y(k,119) + (rxt(k,202)*y(k,117) + &
                 rxt(k,204)*y(k,94) +rxt(k,205)*y(k,92) +rxt(k,206)*y(k,113) + &
                 rxt(k,207)*y(k,100) +rxt(k,208)*y(k,127) +rxt(k,209)*y(k,97) + &
                 2.000_r8*rxt(k,210)*y(k,115) +3.000_r8*rxt(k,211)*y(k,95) + &
                 rxt(k,212)*y(k,90) +2.000_r8*rxt(k,213)*y(k,96) + &
                 ...
                 rxt(k,381)*y(k,108) +2.000_r8*rxt(k,382)*y(k,102))*y(k,98) &
                  + (rxt(k,245)*y(k,115) +2.000_r8*rxt(k,246)*y(k,95) + &
                 rxt(k,250)*y(k,112) +rxt(k,252)*y(k,91) + &
                 2.000_r8*rxt(k,253)*y(k,114))*y(k,118) + (rxt(k,152)*y(k,115) + &
                 2.000_r8*rxt(k,153)*y(k,95) +rxt(k,156)*y(k,112) + &
                 rxt(k,159)*y(k,91) +2.000_r8*rxt(k,160)*y(k,114))*y(k,128) &
                  + (rxt(k,344)*y(k,134) +rxt(k,410)*y(k,101))*y(k,40) + (rxt(k,274) + &
                 rxt(k,293)*y(k,58))*y(k,114) + (rxt(k,282) +rxt(k,295)*y(k,51)) &
                 *y(k,115) +.050_r8*rxt(k,25)*y(k,23) +rxt(k,353)*y(k,135)*y(k,41) &
                  +rxt(k,100)*y(k,44) +rxt(k,385)*y(k,91) +rxt(k,284)*y(k,95) &
                  +rxt(k,373)*y(k,102) +rxt(k,273)*y(k,112) +rxt(k,94)*y(k,129)
      end do
