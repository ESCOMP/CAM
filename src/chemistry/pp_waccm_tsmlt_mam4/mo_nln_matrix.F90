      ...
      do k = 1,avec_len
         ...
         mat(k,2131) = rxt(k,255)*y(k,19) + (4.000_r8*rxt(k,222)+2.000_r8*rxt(k,224)) &
                      *y(k,59) + rxt(k,226)*y(k,124) + rxt(k,231)*y(k,133) &
                      + rxt(k,507)*y(k,151) + rxt(k,221)*y(k,197) + rxt(k,232) &
                      *y(k,221)
         ...
         mat(k,2143) = -(rxt(k,221)*y(k,197) + (4._r8*rxt(k,222) + 4._r8*rxt(k,223) &
                      ...
                      *y(k,133) + (rxt(k,232) + rxt(k,233)) * y(k,221) + (rxt(k,254) &
                      + rxt(k,255) + rxt(k,256)) * y(k,19) + rxt(k,507)*y(k,151))
         ...
         mat(k,234) = rxt(k,512)*y(k,151)
         mat(k,1330) = mat(k,1330) + rxt(k,512)*y(k,137)
         ...
         mat(k,1812) = rxt(k,296)*y(k,42) + rxt(k,502)*y(k,138)
         ...
         mat(k,254) = rxt(k,502)*y(k,133) + rxt(k,503)*y(k,221)
         ...
         mat(k,1694) = mat(k,1694) + .350_r8*rxt(k,317)*y(k,24) + rxt(k,297)*y(k,42) &
                      + rxt(k,355)*y(k,49) + rxt(k,342)*y(k,75) + rxt(k,503)*y(k,138) &
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,191) = -(rxt(k,516)*y(k,126) + (rxt(k,517) + rxt(k,519)) * y(k,221))
         ...
         mat(k,258) = rxt(k,503)*y(k,221)
         mat(k,606) = rxt(k,508)*y(k,221)
         mat(k,1326) = rxt(k,513)*y(k,221)
         ...
         mat(k,1724) = rxt(k,297)*y(k,42) + rxt(k,315)*y(k,62) + rxt(k,179)*y(k,77) &
                      ...
                      *y(k,138) + rxt(k,508)*y(k,149) + rxt(k,513)*y(k,151)
         ...
         mat(k,172) = rxt(k,515)*y(k,232)
         mat(k,2145) = rxt(k,515)*y(k,153)
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,1994) = -((rxt(k,191) + rxt(k,192) + rxt(k,193)) * y(k,112) + (rxt(k,195) &
                      ...
                      *y(k,210) + rxt(k,462)*y(k,142) + rxt(k,465)*y(k,189) + rxt(k,509) &
                      *y(k,151))
         ...
         mat(k,1824) = -(rxt(k,167)*y(k,135) + 4._r8*rxt(k,168)*y(k,133) + rxt(k,169) &
                      ...
                      *y(k,203) + rxt(k,182)*y(k,221) + (rxt(k,195) + rxt(k,197) &
                      ...
                      + rxt(k,502)*y(k,138) + (rxt(k,569) + rxt(k,570)) * y(k,213) &
                      + rxt(k,571)*y(k,215))
         ...
         mat(k,1433) = mat(k,1433) + rxt(k,194)*y(k,112) + rxt(k,504)*y(k,149) &
                      + rxt(k,510)*y(k,151) + rxt(k,573)*y(k,215) + (rxt(k,156) &
         ...
         mat(k,1427) = -(rxt(k,156)*y(k,217) + rxt(k,161)*y(k,218) + rxt(k,169) &
                      ...
                      *y(k,112) + rxt(k,340)*y(k,201) + rxt(k,504)*y(k,149) + rxt(k,510) &
         ...
         mat(k,1777) = rxt(k,252)*y(k,17) + rxt(k,220)*y(k,56) + rxt(k,178)*y(k,76) &
                      ...
                      + 2.000_r8*rxt(k,167)*y(k,133) + rxt(k,505)*y(k,149) &
                      + rxt(k,511)*y(k,151) + 2.000_r8*rxt(k,177)*y(k,203) &
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,1782) = -(rxt(k,158)*y(k,217) + rxt(k,167)*y(k,133) + rxt(k,177) &
                      ...
                      *y(k,142) + rxt(k,480)*y(k,6) + rxt(k,483)*y(k,110) + rxt(k,505) &
                      *y(k,149) + rxt(k,511)*y(k,151))
         ...
         mat(k,230) = -(rxt(k,512)*y(k,151))
         mat(k,1315) = -rxt(k,512)*y(k,137)
         mat(k,2000) = rxt(k,254)*y(k,59)
         mat(k,2121) = rxt(k,254)*y(k,19) + 2.000_r8*rxt(k,224)*y(k,59)
         mat(k,251) = -(rxt(k,502)*y(k,133) + rxt(k,503)*y(k,221))
         mat(k,1795) = -rxt(k,502)*y(k,138)
         mat(k,1622) = -rxt(k,503)*y(k,138)
         ...
         mat(k,600) = -(rxt(k,504)*y(k,134) + rxt(k,505)*y(k,135) + rxt(k,508) &
                      *y(k,221))
         mat(k,1417) = -rxt(k,504)*y(k,149)
         mat(k,1744) = -rxt(k,505)*y(k,149)
         mat(k,1662) = -rxt(k,508)*y(k,149)
         mat(k,1318) = -(rxt(k,506)*y(k,19) + rxt(k,507)*y(k,59) + rxt(k,509)*y(k,125) &
                      + rxt(k,510)*y(k,134) + rxt(k,511)*y(k,135) + rxt(k,512) &
                      *y(k,137) + rxt(k,513)*y(k,221))
         mat(k,2004) = -rxt(k,506)*y(k,151)
         mat(k,2125) = -rxt(k,507)*y(k,151)
         mat(k,1979) = -rxt(k,509)*y(k,151)
         mat(k,1425) = -rxt(k,510)*y(k,151)
         mat(k,1774) = -rxt(k,511)*y(k,151)
         mat(k,232) = -rxt(k,512)*y(k,151)
         mat(k,1711) = -rxt(k,513)*y(k,151)
         mat(k,1814) = rxt(k,502)*y(k,138)
         mat(k,1425) = mat(k,1425) + rxt(k,504)*y(k,149)
         mat(k,1774) = mat(k,1774) + rxt(k,505)*y(k,149)
         mat(k,255) = rxt(k,502)*y(k,133)
         mat(k,601) = rxt(k,504)*y(k,134) + rxt(k,505)*y(k,135) + rxt(k,508)*y(k,221)
         mat(k,1711) = mat(k,1711) + rxt(k,508)*y(k,149)
         mat(k,892) = -(rxt(k,514)*y(k,221))
         mat(k,1684) = -rxt(k,514)*y(k,152)
         mat(k,2003) = rxt(k,506)*y(k,151)
         mat(k,2123) = rxt(k,507)*y(k,151)
         mat(k,192) = rxt(k,516)*y(k,126) + (rxt(k,517)+.500_r8*rxt(k,519))*y(k,221)
         mat(k,1972) = rxt(k,509)*y(k,151)
         mat(k,1871) = rxt(k,516)*y(k,67)
         mat(k,1422) = rxt(k,510)*y(k,151)
         mat(k,1752) = rxt(k,511)*y(k,151)
         mat(k,231) = rxt(k,512)*y(k,151)
         mat(k,253) = rxt(k,503)*y(k,221)
         mat(k,1317) = rxt(k,506)*y(k,19) + rxt(k,507)*y(k,59) + rxt(k,509)*y(k,125) &
                      + rxt(k,510)*y(k,134) + rxt(k,511)*y(k,135) + rxt(k,512) &
                      *y(k,137) + rxt(k,513)*y(k,221)
         mat(k,1684) = mat(k,1684) + (rxt(k,517)+.500_r8*rxt(k,519))*y(k,67) &
                      + rxt(k,503)*y(k,138) + rxt(k,513)*y(k,151)
         mat(k,173) = -(rxt(k,515)*y(k,232))
         mat(k,2147) = -rxt(k,515)*y(k,153)
         mat(k,891) = rxt(k,514)*y(k,221)
         mat(k,1610) = rxt(k,514)*y(k,152)
         ...
         mat(k,113) = .0232005_r8*rxt(k,546)*y(k,221)
         ...
         mat(k,1587) = .114_r8*rxt(k,536)*y(k,6) + .1621005_r8*rxt(k,537)*y(k,7) &
                      ...
                      *y(k,104) + .1278005_r8*rxt(k,544)*y(k,110) &
                      + .0128005_r8*rxt(k,545)*y(k,173) + .0232005_r8*rxt(k,546) &
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,196) = .500_r8*rxt(k,519)*y(k,221)
         ...
         mat(k,1728) = mat(k,1728) + .650_r8*rxt(k,438)*y(k,7) + rxt(k,262)*y(k,19) &
                      ...
                      *y(k,135) + .800_r8*rxt(k,461)*y(k,143) + rxt(k,514)*y(k,152) &
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,1719) = -(rxt(k,179)*y(k,77) + rxt(k,180)*y(k,79) + rxt(k,181)*y(k,203) &
                      ...
                      *y(k,178) + rxt(k,501)*y(k,179) + rxt(k,503)*y(k,138) + rxt(k,508) &
                      *y(k,149) + rxt(k,513)*y(k,151) + rxt(k,514)*y(k,152) + (rxt(k,517) &
         ...
         mat(k,256) = -rxt(k,503)*y(k,221)
         mat(k,603) = -rxt(k,508)*y(k,221)
         mat(k,1323) = -rxt(k,513)*y(k,221)
         mat(k,894) = -rxt(k,514)*y(k,221)
         mat(k,193) = -(rxt(k,517) + rxt(k,519)) * y(k,221)
         mat(k,50) = -rxt(k,518)*y(k,221)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,2170) = -(rxt(k,154)*y(k,217) + rxt(k,273)*y(k,73) + rxt(k,515) &
                      *y(k,153))
         mat(k,1582) = -rxt(k,154)*y(k,232)
         mat(k,680) = -rxt(k,273)*y(k,232)
         mat(k,176) = -rxt(k,515)*y(k,232)
