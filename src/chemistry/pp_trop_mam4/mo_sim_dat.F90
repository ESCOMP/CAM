...
!--------------------------------------------------------------
      ...
      solsym(: 25) = (/ 'bc_a1           ','bc_a4           ','DMS             ','dst_a1          ','dst_a2          ', &
      ...
      adv_mass(: 25) = (/    12.011000_r8,    12.011000_r8,    62.132400_r8,   135.064039_r8,   135.064039_r8, &
      ...
      crb_mass(: 25) = (/    12.011000_r8,    12.011000_r8,    24.022000_r8,     0.000000_r8,     0.000000_r8, &
      ...
      diag_map(: 25) = (/    1,   2,   3,   5,   6,   7,   8,  10,  11,  12, &
