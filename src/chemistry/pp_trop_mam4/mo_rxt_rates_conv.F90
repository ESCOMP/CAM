...
contains
   subroutine set_rates( rxt_rates, sol, ncol )
      ...
      rxt_rates(:ncol,:,     2) = rxt_rates(:ncol,:,     2)*sol(:ncol,:,    24)                                                ! rate_const*soa_a1
      rxt_rates(:ncol,:,     3) = rxt_rates(:ncol,:,     3)*sol(:ncol,:,    25)                                                ! rate_const*soa_a2
      ...
      rxt_rates(:ncol,:,     8) = rxt_rates(:ncol,:,     8)*sol(:ncol,:,     3)                                                ! rate_const*OH*DMS
      rxt_rates(:ncol,:,     9) = rxt_rates(:ncol,:,     9)*sol(:ncol,:,    18)                                                ! rate_const*OH*SO2
      rxt_rates(:ncol,:,    10) = rxt_rates(:ncol,:,    10)*sol(:ncol,:,    23)                                                ! rate_const*SOAE
