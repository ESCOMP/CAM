...
!--------------------------------------------------------------------
         ...
         prod(2) = 0._r8
         loss(3) = ( + rxt(6) + rxt(7) + rxt(8) + het_rates(3))* y(3)
         prod(3) = 0._r8
         ...
         prod(6) = 0._r8
         loss(7) = ( + rxt(1) + rxt(4) + het_rates(7))* y(7)
         prod(7) = 0._r8
         ...
         prod(17) = 0._r8
         loss(18) = ( + rxt(9) + het_rates(18))* y(18)
         prod(18) = (rxt(6) +rxt(7) +.500_r8*rxt(8))*y(3)
         ...
         prod(22) =rxt(10)*y(23)
         loss(23) = ( + rxt(10) + het_rates(23))* y(23)
         prod(23) = 0._r8
         loss(24) = ( + rxt(2) + het_rates(24))* y(24)
         prod(24) = 0._r8
         loss(25) = ( + rxt(3) + het_rates(25))* y(25)
         prod(25) = 0._r8
