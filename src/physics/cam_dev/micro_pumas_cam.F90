...
!   call addfld ('qctend_TAU',     (/ 'trop_cld_lev' /), 'A', 'kg/kg/s',  'cloud liquid mass tendency due to autoconversion & accretion from TAU or Emulator code')
...
!++ TAU
   if (trim(micro_mg_warm_rain) == 'tau' .or. trim(micro_mg_warm_rain) == 'emulated') then
      ...
      call outfld('QC_TAU_in',  proc_rates%qc_in,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('NC_TAU_in',  proc_rates%nc_in,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('QR_TAU_in',  proc_rates%qr_in,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('NR_TAU_in',  proc_rates%nr_in,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('QC_TAU_out',  proc_rates%qc_out,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('NC_TAU_out',  proc_rates%nc_out,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('QR_TAU_out',  proc_rates%qr_out,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
      call outfld('NR_TAU_out',  proc_rates%nr_out,      ncol, lchnk, avg_subcol_field=use_subcol_microp)
