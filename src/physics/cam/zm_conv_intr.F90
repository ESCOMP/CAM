...
subroutine zm_conv_readnl(nlfile)
   ...
   call mpi_bcast(zmconv_dmpdz,             1, mpi_logical, masterprocid, mpicom, ierr)
   if (ierr /= 0) call endrun("zm_conv_readnl: FATAL: mpi_bcast: zmconv_dmpdz")
   call mpi_bcast(zmconv_tiedke_add,        1, mpi_logical, masterprocid, mpicom, ierr)
   if (ierr /= 0) call endrun("zm_conv_readnl: FATAL: mpi_bcast: zmconv_tiedke_add")
   call mpi_bcast(zmconv_capelmt,           1, mpi_logical, masterprocid, mpicom, ierr)
