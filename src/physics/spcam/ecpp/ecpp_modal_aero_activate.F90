...
!-----------------------------------------------------------------------
	subroutine parampollu_tdx_activate1( aero_props,          &
...
!	    stop '*** parampollu_tdx_activate1 - cannot do activate_onoff_use < 100'
	    ...
	    call parampollu_tdx_activate_intface( aero_props,     &
		ktau, ktau_pp,                                    &
		idiagaa_ecpp, ldiagaa_ecpp,                       &
		ncls_ecpp, ncls_use,                              &
		it,      jt,      kts,ktebnd,ktecen,              &
...
!-----------------------------------------------------------------------
	subroutine parampollu_tdx_activate_intface( aero_props,   &
		ktau, ktau_pp,                                    &
		idiagaa_ecpp, ldiagaa_ecpp,                       &
		ncls_ecpp, ncls_use,                              &
...
!   do activate call
        ...
        call activate_aerosol( wbar, wmix, wdiab, wmin, wmax, tempair, rhoair, &
            naerosol(m,:), ntype_aer, &
            vaerosol(m,:), hygro(m,:), aero_props, &
