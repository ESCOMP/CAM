...
### Jonah Shaw, 2026/02/18 (jonah.shaw@colorado.edu, @jshaw35 on github)
...
1. Set $RTTOVDIR to point to the directory where RTTOV is installed.
...
1. Add COSP and RTTOV to CAM_CONFIG_OPTS before running ./case.setup by running './xmlchange --append CAM_CONFIG_OPTS="-cosp -rttov"'
2. Run './xmlchange FORCE_BUILD_SMP=TRUE' before running ./case.setup.
...
cosp_rttov_instrument_namelists = '$SRCROOT/src/physics/cosp2/COSP-RTTOV_examples/cosp2_rttov_inst_CESM.txt'
...
Set "rttov_coefDir" as the directory RTTOV coefficients are stored. "rttov_srcDir" and "rttov_coefDir" are used together when loading coefficients.
