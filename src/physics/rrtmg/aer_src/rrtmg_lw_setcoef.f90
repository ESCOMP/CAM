...
! ----- Input -----
      ...
      real(kind=r8), intent(in) :: pavel(nlayers)           ! layer pressures (mb) 
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: tavel(nlayers)           ! layer temperatures (K)
                                                        !    Dimensions: (nlayers)
      ...
      real(kind=r8), intent(in) :: coldry(nlayers)          ! dry air column density (mol/cm2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: wbroad(nlayers)          ! broadening gas column density (mol/cm2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(in) :: wkl(mxmol,nlayers)           ! molecular amounts (mol/cm-2)
...
! ----- Output -----
      ...
      integer, intent(out) :: jp(nlayers)          ! 
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: jt(nlayers)          !
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: jt1(nlayers)         !
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: planklay(nlayers,nbndlw)     ! 
                                                        !    Dimensions: (nlayers,nbndlw)
      real(kind=r8), intent(out) :: planklev(0:nlayers,nbndlw)    ! 
                                                        !    Dimensions: (0:nlayers,nbndlw)
      real(kind=r8), intent(out) :: plankbnd(nbndlw)       ! 
                                                        !    Dimensions: (nbndlw)

      real(kind=r8), intent(out) :: colh2o(nlayers)         ! column amount (h2o)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colco2(nlayers)         ! column amount (co2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colo3(nlayers)          ! column amount (o3)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: coln2o(nlayers)         ! column amount (n2o)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colco(nlayers)          ! column amount (co)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colch4(nlayers)         ! column amount (ch4)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colo2(nlayers)          ! column amount (o2)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: colbrd(nlayers)         ! column amount (broadening gases)
                                                        !    Dimensions: (nlayers)

      integer, intent(out) :: indself(nlayers)
                                                        !    Dimensions: (nlayers)
      integer, intent(out) :: indfor(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: selffac(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: selffrac(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: forfac(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: forfrac(nlayers)
                                                        !    Dimensions: (nlayers)

      integer, intent(out) :: indminor(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: minorfrac(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: scaleminor(nlayers)
                                                        !    Dimensions: (nlayers)
      real(kind=r8), intent(out) :: scaleminorn2(nlayers)
                                                        !    Dimensions: (nlayers)
